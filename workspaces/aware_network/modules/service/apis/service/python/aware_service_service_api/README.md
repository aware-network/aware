# aware_service_service_api

Generated API client package.

Canonical API boundary for Service operation DTO ownership and future service-control capabilities.

## Install

```bash
pip install aware-service-service-api
```
...
from aware_service_service_api import AwareServiceServiceApiClient

api = AwareServiceServiceApiClient(AwareApiEndpointInvoker(...))
```
