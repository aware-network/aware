...
class AwareCodeSdk:
    ...
    async def describe_semantic_contract(
        ...
        resolved_request = request or DescribeCodeSemanticContractRequest(
    ...
    async def resolve_generated_materialization_package_delta(
        ...
        return await self.api_client.code.generated_materialization_delta.resolve_package_delta(
            request
        )
    ...
    def semantic_ownership_provider(self) -> CodeSdkSemanticOwnershipProvider:
        ...
        if isinstance(local_client, LocalCodeSdkApiClient):
            return LocalCatalogCodeSdkSemanticOwnershipProvider(
                semantic_contracts=tuple(local_client.catalog.semantic_contracts),
            )
