...
class LanguageServiceWorkspaceHost(Protocol):
    workspace_root: Path

    def get_document_text(self, uri: str) -> str: ...

    def capability_owner_plan_for_uri(
        self,
        *,
        uri: str,
    ) -> CodeLanguageServiceCapabilityOwnerPlan: ...
...
class ServiceMixinBase(ABC):
    ...
    _workspace: LanguageServiceWorkspaceHost
    ...
    def _capability_execution_plan_for_uri(
        ...
        *,
        ...
        get_registered_descriptors: Callable[
        ...
        def _build_plan() -> CapabilityExecutionPlan:
            workspace_owner_plan = self._workspace.capability_owner_plan_for_uri(
                uri=uri
            )
