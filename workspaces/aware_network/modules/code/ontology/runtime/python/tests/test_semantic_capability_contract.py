...
from aware_code.package.semantic_contract import package_semantic_contract_callable_name
...
def test_semantic_analysis_is_a_code_owned_package_contract_capability() -> None:
    assert (
        package_semantic_contract_callable_name(capability=SEMANTIC_ANALYSIS_CAPABILITY)
        == "semantic_analysis"
    )
