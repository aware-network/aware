...
class CodeViewActionCapabilityClient:
    def __init__(self, client: AwareApiEndpointInvoker) -> None:
        self._client = client

    async def select_code(self, request: SelectCodeViewActionRequest) -> SelectCodeViewActionResponse:
        """Select one Code source in the package selector and request downstream editor focus."""
        return cast(
            SelectCodeViewActionResponse,
            await self._client.invoke_api_endpoint(
                manifest=API_INVOCATION_MANIFEST,
    ...
    async def select_section(self, request: SelectCodeSectionViewActionRequest) -> SelectCodeSectionViewActionResponse:
        """Select one Code section anchor in the editor view."""
        return cast(
            SelectCodeSectionViewActionResponse,
            await self._client.invoke_api_endpoint(
                manifest=API_INVOCATION_MANIFEST,
...
class CodeViewStateCapabilityClient:
    def __init__(self, client: AwareApiEndpointInvoker) -> None:
        self._client = client
...
class CodeApiClient:
    def __init__(self, client: AwareApiEndpointInvoker) -> None:
        ...
        self.view_action = CodeViewActionCapabilityClient(client)
        self.view_state = CodeViewStateCapabilityClient(client)
...
__all__ = [
    ...
    "CodeViewActionCapabilityClient",
    "CodeViewStateCapabilityClient",
]
