...
"""
    ...
    assert port_args["node_thread_key_message_id"] == ProgramRef(
...
"""
    ...
    body_types = [
        child.type for child in body_node.named_children if child.type != "comment"
    ]
...
"""
    ...
    body_types = [
        child.type for child in class_node.named_children if child.type != "comment"
    ]
