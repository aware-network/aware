...
def test_compile_typed_action_continuation_intrinsics_and_round_trip() -> None:
    plan = compile_invocation_plans(
        """\
program ContinuationGraph {
    call program.continuation_action(
        key="remember",
        action_config_id="00000000-0000-0000-0000-000000000001",
        event_config_id="00000000-0000-0000-0000-000000000002",
        api_capability_endpoint_id="00000000-0000-0000-0000-000000000003",
        request_class_config_id="00000000-0000-0000-0000-000000000015",
        response_class_config_id="00000000-0000-0000-0000-000000000016"
    )
    call program.continuation_action(
        key="resolve",
        action_config_id="00000000-0000-0000-0000-000000000004",
        event_config_id="00000000-0000-0000-0000-000000000002",
        api_capability_endpoint_id="00000000-0000-0000-0000-000000000005",
        request_class_config_id="00000000-0000-0000-0000-000000000017",
        response_class_config_id="00000000-0000-0000-0000-000000000018"
    )
    call program.continuation_action(
        key="record",
        action_config_id="00000000-0000-0000-0000-000000000006",
        event_config_id="00000000-0000-0000-0000-000000000002",
        api_capability_endpoint_id="00000000-0000-0000-0000-000000000007",
        request_class_config_id="00000000-0000-0000-0000-000000000019",
        response_class_config_id="00000000-0000-0000-0000-000000000020"
    )
    call program.continuation_activation_field(
        source_input="semantic_event",
        source_class_config_id="00000000-0000-0000-0000-000000000021",
        source_attribute_config_id="00000000-0000-0000-0000-000000000008",
        target_intent="resolve",
        target_request_attribute_config_id="00000000-0000-0000-0000-000000000009"
    )
    call program.continuation_outcome_field(
        source_intent="remember",
        source_response_attribute_config_id="00000000-0000-0000-0000-000000000010",
        target_intent="record",
        target_request_attribute_config_id="00000000-0000-0000-0000-000000000011"
    )
    call program.continuation_receipt_field(
        source_intent="resolve",
        source_receipt_class_config_id="00000000-0000-0000-0000-000000000012",
        source_receipt_attribute_config_id="00000000-0000-0000-0000-000000000013",
        target_intent="record",
        target_request_attribute_config_id="00000000-0000-0000-0000-000000000014",
        position=2
    )
}
"""
    ...
    intent_steps = [
        step for step in plan.steps if isinstance(step, PlanIntentActionConfig)
    ]
    assert [step.continuation_key for step in intent_steps] == [
        "remember",
        "resolve",
        "record",
    ]
    activation, outcome, receipt = plan.action_continuation_bindings
    assert isinstance(activation, PlanActionContinuationActivationFieldBinding)
    assert activation.source_input_key == "semantic_event"
    assert isinstance(outcome, PlanActionContinuationOutcomeFieldBinding)
    assert outcome.source_intent_key == "remember"
    assert isinstance(receipt, PlanActionContinuationReceiptFieldBinding)
    assert receipt.position == 2
    assert (
        decode_invocation_plan_artifact(encode_invocation_plan_artifact(plan)) == plan
    )


def test_compile_action_continuation_rejects_forward_and_ambiguous_edges() -> None:
    with pytest.raises(
        ProgramCompileError,
        match="outcome source must precede",
    ):
        _ = compile_invocation_plans(
            """\
program ForwardGraph {
    call program.continuation_action(
        key="target",
        action_config_id="00000000-0000-0000-0000-000000000001",
        event_config_id="00000000-0000-0000-0000-000000000002",
        api_capability_endpoint_id="00000000-0000-0000-0000-000000000003",
        request_class_config_id="00000000-0000-0000-0000-000000000009",
        response_class_config_id="00000000-0000-0000-0000-000000000010"
    )
    call program.continuation_action(
        key="source",
        action_config_id="00000000-0000-0000-0000-000000000004",
        event_config_id="00000000-0000-0000-0000-000000000002",
        api_capability_endpoint_id="00000000-0000-0000-0000-000000000005",
        request_class_config_id="00000000-0000-0000-0000-000000000011",
        response_class_config_id="00000000-0000-0000-0000-000000000012"
    )
    call program.continuation_outcome_field(
        source_intent="source",
        source_response_attribute_config_id="00000000-0000-0000-0000-000000000006",
        target_intent="target",
        target_request_attribute_config_id="00000000-0000-0000-0000-000000000007"
    )
}
"""
        )
    ...
    with pytest.raises(
        ProgramCompileError,
        match="ambiguously target",
    ):
        _ = compile_invocation_plans(
            """\
program AmbiguousGraph {
    call program.continuation_action(
        key="source",
        action_config_id="00000000-0000-0000-0000-000000000001",
        event_config_id="00000000-0000-0000-0000-000000000002",
    ...
    call program.continuation_activation_field(
        source_input="event",
        source_class_config_id="00000000-0000-0000-0000-000000000013",
        source_attribute_config_id="00000000-0000-0000-0000-000000000006",
        target_intent="target",
        target_request_attribute_config_id="00000000-0000-0000-0000-000000000007"
    )
    call program.continuation_outcome_field(
        source_intent="source",
        source_response_attribute_config_id="00000000-0000-0000-0000-000000000008",
        target_intent="target",
        target_request_attribute_config_id="00000000-0000-0000-0000-000000000007"
    )
}
...
def test_compile_type_id_sugar_resolves_from_explicit_contracts() -> None:
    plans = compile_invocation_plans(
        """\
...
def test_compile_program_config_plan_rejects_port_node_without_identity_or_keys() -> (
    ...
    with pytest.raises(
        ProgramCompileError,
        match=(
            r"port node ref must use `<opg-node>\.<identity>` or provide resolver "
            + r"keys via `<opg-node>\(<keys\.\.\.>\)`"
        ),
    ):
        _ = compile_program_config_plans(
            """\
