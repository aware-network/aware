...
from aware_experience_ontology_orm_models.invocation.experience_invocation_action_target_kind import (
...
if TYPE_CHECKING:
    ...
    from aware_experience_ontology_orm_models.invocation.role_config_invocation_action_config import (
