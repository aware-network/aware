...
CREATE TABLE program_turn_instruction_invoke (
  ...
  program_actor_role_id TEXT NOT NULL,
  projection_experience_node_class_identity_id TEXT NOT NULL,
  -- CONSTRAINTS
  PRIMARY KEY (branch_id, projection_hash, id),
  UNIQUE (branch_id, projection_hash, program_impl_instruction_invoke_id, program_actor_role_id, projection_experience_node_class_identity_id),
