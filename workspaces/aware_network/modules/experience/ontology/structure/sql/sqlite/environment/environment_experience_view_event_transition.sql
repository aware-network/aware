...
CREATE TABLE environment_experience_view_event_transition (
  ...
  target_section_graph_binding_id TEXT NOT NULL,
  -- ATTRIBUTES
  ...
  UNIQUE (branch_id, projection_hash, environment_experience_profile_config_id, transition_key, source_view_id, trigger_event_id, target_section_graph_binding_id),
