...
CREATE TABLE projection_experience_section_graph_binding (
  ...
  UNIQUE (branch_id, projection_hash, projection_experience_id, binding_key, layout_config_section_config_id, projection_experience_view_id, projection_experience_graph_identity_id)
);
