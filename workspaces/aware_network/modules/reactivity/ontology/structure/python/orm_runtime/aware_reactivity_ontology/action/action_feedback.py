...
class ActionFeedback(ORMModel):
    # Relationships
    api_call_stream_event: ApiCallStreamEvent | None = Field(default=None)
    ...
    api_call_stream_event_id: UUID | None = Field(
        default=None, description="Foreign key for ActionFeedback.api_call_stream_event"
    )
