...
try:
    from aware_reactivity_ontology.stable_ids import (  # type: ignore[import-not-found]  # noqa: F401
        ...
        stable_event_config_condition_config_scope_id as _generated_stable_event_config_condition_config_scope_id,
    ...
    def stable_event_config_condition_config_scope_id(
        *,
        ...
        normalized_scope_key = (scope_key or "").casefold().strip() or "lane"
        return _generated_stable_event_config_condition_config_scope_id(
    ...
    def stable_event_config_condition_config_scope_id(
        *,
        ...
        scope_key_norm = (scope_key or "").casefold().strip() or "lane"
        return uuid5(
            NS_REACTIVITY,
            "event_config_condition_config_scope:"
            f"{event_config_condition_config_id}:{object_instance_graph_identity_id}:{scope_key_norm}",
        )
