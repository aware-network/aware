...
class ActionFeedback(BaseModel):
    ...
    api_call_stream_event_id: UUID | None = Field(
        default=None,
        description="API stream receipt this lifecycle feedback was derived from.\nStream payload content lives once on `ApiCallStreamEvent.event_model`;\nthis DTO carries only the receipt correlation id.",
    )
