...
from aware_reactivity.subscription_contract import (
    ActorSubscriptionBridgeConfig,
)
from aware_reactivity_service_dto.reactivity.action_request import (
    ReactivityActionExecutionRequest,
)
from aware_reactivity_service_dto.reactivity.action_request import (
    ReactivityActionExecutionResult,
)
...
class ReactivityActionExecutor(Protocol):
    async def execute(
        self, *, request: ReactivityActionExecutionRequest
    ) -> ReactivityActionExecutionResult: ...
