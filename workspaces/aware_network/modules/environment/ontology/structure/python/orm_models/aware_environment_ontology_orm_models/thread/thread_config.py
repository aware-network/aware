...
if TYPE_CHECKING:
    from aware_environment_ontology_orm_models.thread.thread_config_layout_config import ThreadConfigLayoutConfig
    from aware_environment_ontology_orm_models.thread.thread_config_object_projection_graph import (
