...
if TYPE_CHECKING:
    ...
    from aware_environment_ontology_dto.environment.environment_profile_actor_config import (
        EnvironmentProfileActorConfig,
    )
    from aware_environment_ontology_dto.environment.environment_provider import EnvironmentProvider
...
class EnvironmentProfileConfig(BaseModel):
    ...
    environment_config: EnvironmentConfig | None = Field(
        default=None, description="Reverse view for EnvironmentConfig.profile_configs"
    )
