...
CREATE TABLE environment_profile_package_dependency (
  ...
  id UUID NOT NULL,
  -- RELATIONSHIPS
  environment_profile_package_id UUID NOT NULL,
  target_environment_profile_package_id UUID NOT NULL,
  target_environment_profile_package_object_instance_graph_commit_id UUID,
  -- ATTRIBUTES
  description TEXT,
