# aware_node_service_api

Generated API client package.

Public generated API client and service protocol boundary for live Node host provisioning, environment config, and service route discovery authority.

## Install

```bash
pip install aware-node-service-api
```
...
api = AwareNodeServiceApiClient(AwareApiEndpointInvoker(...))
```
