# aware_economy_service_api

Generated API client package.

Public generated API client and service protocol boundary for the first canonical Economy service protocol rail.

## Install

```bash
pip install aware-economy-service-api
```
...
api = AwareEconomyServiceApiClient(AwareApiEndpointInvoker(...))
```
