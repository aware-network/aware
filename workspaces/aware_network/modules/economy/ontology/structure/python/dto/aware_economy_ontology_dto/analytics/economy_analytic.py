...
if TYPE_CHECKING:
    from aware_economy_ontology_dto.analytics.economy_analytic_execution import EconomyAnalyticExecution
    from aware_economy_ontology_dto.analytics.economy_analytic_metric import EconomyAnalyticMetric


class EconomyAnalytic(BaseModel):
    # Relationships
    analytic_executions: list[EconomyAnalyticExecution] = Field(default_factory=list)
    analytic_metrics: list[EconomyAnalyticMetric] = Field(default_factory=list)
