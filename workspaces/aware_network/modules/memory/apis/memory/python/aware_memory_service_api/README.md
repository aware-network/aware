# aware_memory_service_api

Generated API client package.

Public generated API client and service protocol boundary for canonical Memory working-memory operations.

## Install

```bash
pip install aware-memory-service-api
```
...
from aware_memory_service_api import AwareMemoryServiceApiClient

api = AwareMemoryServiceApiClient(AwareApiEndpointInvoker(...))
```
