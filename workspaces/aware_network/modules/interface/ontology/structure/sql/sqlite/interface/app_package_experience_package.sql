...
CREATE TABLE app_package_experience_package (
  -- PRIMARY KEY
  ...
  experience_package_object_instance_graph_commit_id TEXT,
  -- ATTRIBUTES
  description TEXT,
  role TEXT NOT NULL,
  -- CONSTRAINTS
  PRIMARY KEY (branch_id, projection_hash, id),
  UNIQUE (branch_id, projection_hash, app_package_id, experience_package_id),
