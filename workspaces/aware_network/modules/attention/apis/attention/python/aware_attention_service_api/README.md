...
Public generated API client and service protocol boundary for canonical Attention section focus-scope orchestration.

## Install

```bash
pip install aware-attention-service-api
```
...
api = AwareAttentionServiceApiClient(AwareApiEndpointInvoker(...))
```
