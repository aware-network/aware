...
ONTOLOGY_PACKAGE_CLASS_FQN = "aware_ontology.ontology.OntologyPackage"
ONTOLOGY_CONFIG_CLASS_FQN = "aware_ontology.ontology.OntologyConfig"
...
async def test_ontology_config_handlers_module_proof(
    ...
    with IsolatedAwareRoot(
        ...
        lane = LaneIds(
            branch_id=uuid5(
                NAMESPACE_URL,
                "aware://tests/ontology/config/branch",
            ),
        )
...
async def test_ontology_package_handlers_module_proof(
    ...
    with IsolatedAwareRoot(
        ...
        lane = LaneIds(
            branch_id=uuid5(NAMESPACE_URL, "aware://tests/ontology/branch"),
        )
