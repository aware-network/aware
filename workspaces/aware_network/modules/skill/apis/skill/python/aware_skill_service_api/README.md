# aware_skill_service_api

Generated API client package.

Public API/service API boundary for invoking Skill runs through Service.

## Install

```bash
pip install aware-skill-service-api
```
...
api = AwareSkillServiceApiClient(AwareApiEndpointInvoker(...))
```
