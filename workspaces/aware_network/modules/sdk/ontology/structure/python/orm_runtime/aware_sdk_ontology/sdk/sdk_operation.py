...
class SdkOperation(ORMModel):
    ...
    api_view_capability_endpoints: list[SdkOperationApiViewCapabilityEndpoint] = Field(default_factory=list)
    ...
    async def bind_api_view_capability_endpoint(
        self,
        ...
        result = await invoke_instance(
            orm_model=self, function_name="bind_api_view_capability_endpoint", payload=payload
        )
        value = result.get("value") if isinstance(result, dict) and "value" in result else result
...
class SdkOperationBindApiViewCapabilityEndpointInput(BaseModel):
    sdk_operation_api_capability_endpoint_id: UUID
    api_view_id: UUID
    api_view_capability_endpoint_id: UUID
    api_view_ref: str
...
class SdkOperationBindApiViewCapabilityEndpointOutput(BaseModel):
...
FUNCTIONS = {
    "SdkOperation": {
        ...
        "bind_api_view_capability_endpoint": {
            "canonical": {
                "name": "bind_api_view_capability_endpoint",
                "description": "Bind this SDK operation endpoint to one API view capability endpoint.\n\nContract:\n- The SDK operation must already bind the same API capability endpoint\n  through `SdkOperationApiCapabilityEndpoint`.\n- `api_view_ref`, `action_key`, and `endpoint_ref` preserve API-owned\n  dispatch semantics for Experience/Interface consumers.",
                "is_constructor": False,
            },
            "input": SdkOperationBindApiViewCapabilityEndpointInput,
            "output": SdkOperationBindApiViewCapabilityEndpointOutput,
        },
...
__all__ = [
    ...
    "SdkOperationBindApiViewCapabilityEndpointInput",
    "SdkOperationBindApiViewCapabilityEndpointOutput",
