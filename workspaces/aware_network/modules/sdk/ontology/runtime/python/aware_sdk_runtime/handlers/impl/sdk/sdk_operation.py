...
async def bind_api_view_capability_endpoint(
    ...
    # --- AWARE: LOGIC START bind_api_view_capability_endpoint
    binding = await SdkOperationApiViewCapabilityEndpoint.create_via_sdk_operation(
        sdk_operation_id=sdk_operation.id,
    ...
    if all(existing.id != binding.id for existing in sdk_operation.api_view_capability_endpoints):
        sdk_operation.api_view_capability_endpoints.append(binding)
    return binding
    # --- AWARE: LOGIC END bind_api_view_capability_endpoint
