...
SDK_API_VIEW_OWNER = "aware_sdk.api_view"
...
SDK_SYNTAX_LANES = (
    ...
    ModuleSemanticSyntaxLaneDescriptor(
        lane_key="aware_sdk.api_view",
        semantic_owner=SDK_API_VIEW_OWNER,
        compiler_owner=SDK_API_VIEW_OWNER,
        grammar_rules=("sdk_operation_view_def",),
        semantic_token_types=("keyword", "namespace"),
        semantic_token_modifiers=("sdk",),
    ),
)
