...
def test_sdk_semantic_contract_declares_package_roles_and_lanes() -> None:
    ...
    assert runtime_projection_packages == {
        "sdk-ontology": ("SdkPackage",),
        "api-ontology": ("Api", "ApiPackage"),
        "code-ontology": ("CodePackage",),
    }
...
def test_sdk_semantic_package_metadata_declares_python_public_package(
    ...
    assert metadata["package_name"] == "code-sdk"
    ...
    assert declaration.manifest_path == ("modules/code/sdks/code/python/pyproject.toml")
