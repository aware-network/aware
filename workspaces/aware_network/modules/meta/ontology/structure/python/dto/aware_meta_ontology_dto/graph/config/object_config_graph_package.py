...
# Meta Ontology Dto
from aware_meta_ontology_dto.graph.config.object_config_graph_package_implementation_policy_enums import (
...
if TYPE_CHECKING:
    ...
    from aware_meta_ontology_dto.graph.config.object_config_graph_package_dependency import (
...
class ObjectConfigGraphPackage(BaseModel):
    """
