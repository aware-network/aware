...
if TYPE_CHECKING:
    from aware_meta_ontology_dto.graph.projection.object_projection_graph_binding import ObjectProjectionGraphBinding


class ObjectProjectionGraphDeclaration(BaseModel):
    """
