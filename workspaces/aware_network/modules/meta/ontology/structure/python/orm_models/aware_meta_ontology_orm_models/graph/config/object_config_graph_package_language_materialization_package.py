...
class ObjectConfigGraphPackageLanguageMaterializationPackage(ORMModel):
    """
    ...
    # Foreign Keys
    object_config_graph_package_language_materialization_id: UUID = Field(
        description="Foreign key for ObjectConfigGraphPackageLanguageMaterialization.materialized_packages"
    )
    code_package_id: UUID = Field(
        description="Foreign key for ObjectConfigGraphPackageLanguageMaterializationPackage.code_package"
    )
