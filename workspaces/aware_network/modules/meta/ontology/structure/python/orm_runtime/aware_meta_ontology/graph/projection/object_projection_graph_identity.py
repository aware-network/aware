...
# Meta Ontology
from aware_meta_ontology.graph.projection.object_projection_graph_enums import ObjectProjectionGraphObservableKind
...
class ObjectProjectionGraphIdentityCreateObservableInput(BaseModel):
    observable_key: str
    key: str
    kind: ObjectProjectionGraphObservableKind = Field(default=ObjectProjectionGraphObservableKind.instance)
    label: str | None = Field(default=None)
