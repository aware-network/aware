...
class ClassConfig(ORMModel):
    ...
    async def update_parent_class(self, parent_class_config_id: UUID | None = None) -> None:
        """
        ...
        payload = {"parent_class_config_id": parent_class_config_id}
        await invoke_instance(orm_model=self, function_name="update_parent_class", payload=payload)
        return None
    ...
    async def create_collection_primitive_attribute_config(
        self,
        name: str,
        ...
        """Materialize one primitive collection AttributeConfig and bind it through ClassConfigAttributeConfig."""
        ...
        result = await invoke_instance(
            orm_model=self, function_name="create_collection_primitive_attribute_config", payload=payload
        )
        value = result.get("value") if isinstance(result, dict) and "value" in result else result
        from aware_meta_ontology.attribute.attribute_config import AttributeConfig
...
class ClassConfigUpdateParentClassInput(BaseModel):
    parent_class_config_id: UUID | None = Field(default=None)


class ClassConfigUpdateParentClassOutput(BaseModel):
    pass
...
class ClassConfigCreateCollectionPrimitiveAttributeConfigInput(BaseModel):
    name: str
    collection_kind: AttributeCollectionType = Field(default=AttributeCollectionType.list)
    primitive_base_type: CodePrimitiveBaseType = Field(default=CodePrimitiveBaseType.any)
    description: str | None = Field(default=None)
    default_value: str | None = Field(default=None)
    is_primary: bool = Field(default=False)
...
class ClassConfigCreateCollectionPrimitiveAttributeConfigOutput(BaseModel):
    value: AttributeConfig
...
FUNCTIONS = {
    "ClassConfig": {
        ...
        "update_parent_class": {
            "canonical": {
                "name": "update_parent_class",
                "description": "Update this ClassConfig inheritance parent.\n\nContract:\n- Mutates only this ClassConfig parent reference.\n- `class_fqn` and `name` remain immutable identity.\n- Semantic planners must provide closure evidence for any new parent.",
                "is_constructor": False,
            },
            "input": ClassConfigUpdateParentClassInput,
            "output": ClassConfigUpdateParentClassOutput,
        },
        ...
        "create_collection_primitive_attribute_config": {
            "canonical": {
                "name": "create_collection_primitive_attribute_config",
                "description": "Materialize one primitive collection AttributeConfig and bind it through ClassConfigAttributeConfig.",
                "is_constructor": False,
            },
            "input": ClassConfigCreateCollectionPrimitiveAttributeConfigInput,
            "output": ClassConfigCreateCollectionPrimitiveAttributeConfigOutput,
        },
...
__all__ = [
    ...
    "ClassConfigUpdateParentClassInput",
    "ClassConfigUpdateParentClassOutput",
    ...
    "ClassConfigCreateCollectionPrimitiveAttributeConfigInput",
    "ClassConfigCreateCollectionPrimitiveAttributeConfigOutput",
