...
class ClassConfigAttributeConfig(ORMModel):
    ...
    @classmethod
    async def create_collection_primitive_via_class_config(
        cls,
        class_config_id: UUID,
        owner_key: str,
        name: str,
        ...
        """Create deterministic ClassConfigAttributeConfig link for a primitive collection attribute."""
        ...
        result = await invoke_constructor(
            orm_class=cls, function_name="create_collection_primitive_via_class_config", payload=payload
        )
        value = result.get("value") if isinstance(result, dict) and "value" in result else result
        if isinstance(value, ClassConfigAttributeConfig):
            return value
...
class ClassConfigAttributeConfigCreateCollectionPrimitiveViaClassConfigInput(BaseModel):
    class_config_id: UUID = Field(description="Foreign key for ClassConfig.class_config_attribute_configs")
    owner_key: str
    name: str
...
class ClassConfigAttributeConfigCreateCollectionPrimitiveViaClassConfigOutput(BaseModel):
    value: ClassConfigAttributeConfig
...
FUNCTIONS = {
    "ClassConfigAttributeConfig": {
        ...
        "create_collection_primitive_via_class_config": {
            "canonical": {
                "name": "create_collection_primitive_via_class_config",
                "description": "Create deterministic ClassConfigAttributeConfig link for a primitive collection attribute.",
                "is_constructor": True,
            },
            "input": ClassConfigAttributeConfigCreateCollectionPrimitiveViaClassConfigInput,
            "output": ClassConfigAttributeConfigCreateCollectionPrimitiveViaClassConfigOutput,
        },
...
__all__ = [
    ...
    "ClassConfigAttributeConfigCreateCollectionPrimitiveViaClassConfigInput",
    "ClassConfigAttributeConfigCreateCollectionPrimitiveViaClassConfigOutput",
