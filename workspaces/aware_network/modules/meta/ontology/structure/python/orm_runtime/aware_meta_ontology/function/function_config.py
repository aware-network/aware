...
class FunctionConfig(ORMModel):
    ...
    async def add_collection_primitive_attribute_config(
        self,
        name: str,
        ...
        """
        Attach one pre-existing primitive collection AttributeConfig contract edge under this
        FunctionConfig.
        """
        ...
        result = await invoke_instance(
            orm_model=self, function_name="add_collection_primitive_attribute_config", payload=payload
        )
        value = result.get("value") if isinstance(result, dict) and "value" in result else result
        from aware_meta_ontology.function.function_config_attribute_config import FunctionConfigAttributeConfig
...
class FunctionConfigAddCollectionPrimitiveAttributeConfigInput(BaseModel):
    name: str
...
class FunctionConfigAddCollectionPrimitiveAttributeConfigOutput(BaseModel):
    value: FunctionConfigAttributeConfig
...
FUNCTIONS = {
    "FunctionConfig": {
        ...
        "add_collection_primitive_attribute_config": {
            "canonical": {
                "name": "add_collection_primitive_attribute_config",
                "description": "Attach one pre-existing primitive collection AttributeConfig contract edge under this FunctionConfig.",
                "is_constructor": False,
            },
            "input": FunctionConfigAddCollectionPrimitiveAttributeConfigInput,
            "output": FunctionConfigAddCollectionPrimitiveAttributeConfigOutput,
        },
...
__all__ = [
    ...
    "FunctionConfigAddCollectionPrimitiveAttributeConfigInput",
    "FunctionConfigAddCollectionPrimitiveAttributeConfigOutput",
