...
class AttributeConfig(ORMModel):
    ...
    async def create_collection_primitive(
        ...
        """
        Create deterministic primitive collection AttributeConfig and materialize descriptor chain.

        Contract:
        - This is the canonical FunctionCall rail for list/set primitive attributes.
        - Non-primitive element descriptors remain explicit unsupported cases until their typed rails land.
        """
...
class AttributeConfigCreateCollectionPrimitiveInput(BaseModel):
    owner_key: str
    name: str
...
class AttributeConfigCreateCollectionPrimitiveOutput(BaseModel):
    value: AttributeConfig
    ...
    "AttributeConfig": {
        ...
        "create_collection_primitive": {
            "canonical": {
                ...
                "description": "Create deterministic primitive collection AttributeConfig and materialize descriptor chain.\n\nContract:\n- This is the canonical FunctionCall rail for list/set primitive attributes.\n- Non-primitive element descriptors remain explicit unsupported cases until their typed rails land.",
                "is_constructor": True,
            },
            "input": AttributeConfigCreateCollectionPrimitiveInput,
            "output": AttributeConfigCreateCollectionPrimitiveOutput,
        },
        "update_primitive": {
            "canonical": {
...
__all__ = [
    ...
    "AttributeConfigCreateCollectionPrimitiveInput",
    "AttributeConfigCreateCollectionPrimitiveOutput",
