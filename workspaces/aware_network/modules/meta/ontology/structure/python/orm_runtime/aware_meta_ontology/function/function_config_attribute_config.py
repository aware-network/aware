...
class FunctionConfigAttributeConfig(ORMModel):
    ...
    @classmethod
    async def create_collection_primitive_via_function_config(
        cls,
        function_config_id: UUID,
        owner_key: str,
        name: str,
        ...
        """
        Create deterministic FunctionConfigAttributeConfig association edge for a primitive collection
        attribute.
        """
        ...
        result = await invoke_constructor(
            orm_class=cls, function_name="create_collection_primitive_via_function_config", payload=payload
        )
        value = result.get("value") if isinstance(result, dict) and "value" in result else result
        if isinstance(value, FunctionConfigAttributeConfig):
            return value
...
class FunctionConfigAttributeConfigCreateCollectionPrimitiveViaFunctionConfigInput(BaseModel):
    function_config_id: UUID = Field(description="Foreign key for FunctionConfig.function_config_attribute_configs")
    owner_key: str
    name: str
...
class FunctionConfigAttributeConfigCreateCollectionPrimitiveViaFunctionConfigOutput(BaseModel):
    value: FunctionConfigAttributeConfig
...
FUNCTIONS = {
    "FunctionConfigAttributeConfig": {
        ...
        "create_collection_primitive_via_function_config": {
            "canonical": {
                "name": "create_collection_primitive_via_function_config",
                "description": "Create deterministic FunctionConfigAttributeConfig association edge for a primitive collection attribute.",
                "is_constructor": True,
            },
            "input": FunctionConfigAttributeConfigCreateCollectionPrimitiveViaFunctionConfigInput,
            "output": FunctionConfigAttributeConfigCreateCollectionPrimitiveViaFunctionConfigOutput,
        },
...
__all__ = [
    ...
    "FunctionConfigAttributeConfigCreateCollectionPrimitiveViaFunctionConfigInput",
    "FunctionConfigAttributeConfigCreateCollectionPrimitiveViaFunctionConfigOutput",
