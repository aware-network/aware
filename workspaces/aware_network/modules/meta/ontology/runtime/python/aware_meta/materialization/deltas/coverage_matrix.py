...
WORKSPACE_DELTA_FIRST_MODE_PUBLIC_GENERATED_APPLY_READY = "public_generated_apply_ready"
...
WORKSPACE_DELTA_FIRST_MODE_EXPLICIT_FALLBACK_REQUIRED = "explicit_fallback_required"
...
_MATRIX: tuple[MetaOcgDeltaCoverageMatrixEntry, ...] = (
    ...
    MetaOcgDeltaCoverageMatrixEntry(
        case_key="object_config_graph_identity.create",
        feature_key="object_config_graph",
        ...
        source_projection_status=STATUS_SKIPPED_POLICY,
        source_projection_reason=(
            "meta_source_projection_object_config_graph_identity_requires_renderer_policy"
        ),
        source_projection_policy=SOURCE_PROJECTION_POLICY_RENDER_ALL_REQUIRED,
        language_target_impact_policy=LANGUAGE_TARGET_STRUCTURAL,
        home_proof_status=HOME_PROOF_COVERED,
        home_proof_refs=(_WORKSPACE_META_GENESIS_DELTA_ONLY_PROOF,),
        notes=(
            "ObjectConfigGraph identity genesis is a graph-structural "
            "FunctionCall under the object_config_graph provider."
        ),
    ),
    MetaOcgDeltaCoverageMatrixEntry(
    ...
    MetaOcgDeltaCoverageMatrixEntry(
        case_key="object_projection_graph_edge.create",
        feature_key="object_projection_graph",
        ...
        source_projection_status=STATUS_SKIPPED_POLICY,
        source_projection_reason=(
            "meta_source_projection_object_projection_graph_edge_requires_renderer_policy"
        ),
        source_projection_policy=SOURCE_PROJECTION_POLICY_RENDER_ALL_REQUIRED,
        language_target_impact_policy=LANGUAGE_TARGET_STRUCTURAL,
        home_proof_status=HOME_PROOF_COVERED,
        home_proof_refs=(_WORKSPACE_META_GENESIS_DELTA_ONLY_PROOF,),
        notes=(
            "OPG edge member creation executes through "
            "ObjectProjectionGraph.create_edge; Workspace delta-first treats it "
            "as graph-only ready until authored projection sections are renderable."
        ),
    ),
    MetaOcgDeltaCoverageMatrixEntry(
        case_key="object_projection_graph_constructor.create",
        feature_key="object_projection_graph",
        ...
        source_projection_status=STATUS_SKIPPED_POLICY,
        source_projection_reason=(
            "meta_source_projection_object_projection_graph_constructor_requires_renderer_policy"
        ),
        source_projection_policy=SOURCE_PROJECTION_POLICY_RENDER_ALL_REQUIRED,
        language_target_impact_policy=LANGUAGE_TARGET_STRUCTURAL,
        home_proof_status=HOME_PROOF_COVERED,
        home_proof_refs=(_WORKSPACE_META_GENESIS_DELTA_ONLY_PROOF,),
        notes=(
            "OPG constructor member creation executes through "
            "ObjectProjectionGraph.create_constructor; Workspace delta-first treats "
            "it as graph-only ready until authored projection sections are renderable."
        ),
    ),
    MetaOcgDeltaCoverageMatrixEntry(
        case_key="object_projection_graph_relationship.create",
        feature_key="object_projection_graph",
        ...
        source_projection_status=STATUS_SKIPPED_POLICY,
        source_projection_reason=(
            "meta_source_projection_object_projection_graph_relationship_requires_renderer_policy"
        ),
        source_projection_policy=SOURCE_PROJECTION_POLICY_RENDER_ALL_REQUIRED,
        language_target_impact_policy=LANGUAGE_TARGET_STRUCTURAL,
        home_proof_status=HOME_PROOF_COVERED,
        home_proof_refs=(_WORKSPACE_META_GENESIS_DELTA_ONLY_PROOF,),
        notes=(
            "OPG relationship member creation executes through "
            "ObjectProjectionGraph.create_relationship; Workspace delta-first "
            "treats it as graph-only ready until authored projection sections are "
            "renderable."
        ),
    ),
    MetaOcgDeltaCoverageMatrixEntry(
        case_key="object_instance_graph.create",
        feature_key="object_projection_graph",
        ...
        source_projection_status=STATUS_SKIPPED_POLICY,
        source_projection_reason=(
            "meta_source_projection_object_instance_graph_requires_renderer_policy"
        ),
        source_projection_policy=SOURCE_PROJECTION_POLICY_RENDER_ALL_REQUIRED,
        language_target_impact_policy=LANGUAGE_TARGET_STRUCTURAL,
        home_proof_status=HOME_PROOF_COVERED,
        home_proof_refs=(_WORKSPACE_META_GENESIS_DELTA_ONLY_PROOF,),
        notes=(
            "OIG genesis executes through "
            "ObjectProjectionGraph.create_object_instance_graph; Workspace "
            "delta-first treats it as graph-only ready until authored projection "
            "sections are renderable."
        ),
    ),
    MetaOcgDeltaCoverageMatrixEntry(
        case_key="object_projection_graph_declaration.create",
        feature_key="object_projection_graph",
        ...
        semantic_change_status=STATUS_READY,
        typed_operation_status=STATUS_READY,
        ontology_execution_status=STATUS_BLOCKED,
        source_projection_status=STATUS_SKIPPED_POLICY,
        source_projection_reason=(
            "meta_source_projection_object_projection_graph_declaration_requires_renderer_policy"
        ),
        source_projection_policy=SOURCE_PROJECTION_POLICY_RENDER_ALL_REQUIRED,
        language_target_impact_policy=LANGUAGE_TARGET_STRUCTURAL,
        home_proof_status=HOME_PROOF_COVERED,
        home_proof_refs=(
            "workspaces/aware_kernel/modules/meta/ontology/runtime/python/"
            "tests/provider_delta/test_ontology_execution_opg_runtime.py",
        ),
        next_priority="P1",
        notes=(
            "Projection declaration typed operations are explicit, but ontology "
    ...
    MetaOcgDeltaCoverageMatrixEntry(
        case_key="object_projection_graph_binding.create",
        feature_key="object_projection_graph",
        ...
        source_projection_status=STATUS_SKIPPED_POLICY,
        source_projection_reason=(
            "meta_source_projection_object_projection_graph_binding_requires_renderer_policy"
        ),
        source_projection_policy=SOURCE_PROJECTION_POLICY_RENDER_ALL_REQUIRED,
        language_target_impact_policy=LANGUAGE_TARGET_STRUCTURAL,
        home_proof_status=HOME_PROOF_MODULE_TESTS,
        home_proof_refs=(
            "workspaces/aware_kernel/modules/meta/ontology/runtime/python/"
            "tests/provider_delta/test_ontology_execution_opg_runtime.py",
        ),
        next_priority="P1",
        notes=(
            "Projection binding typed operations are explicit, but ontology "
            "execution is blocked until "
            "ObjectProjectionGraphDeclaration.create_binding is canonical."
        ),
    ),
    MetaOcgDeltaCoverageMatrixEntry(
    ...
    MetaOcgDeltaCoverageMatrixEntry(
        ...
        source_projection_status=STATUS_READY,
        source_projection_reason=(
            "meta_source_projection_class_config_parent_generated_delta_ready"
        ),
        source_projection_policy=SOURCE_PROJECTION_POLICY_SEGMENT_READY,
        language_target_impact_policy=LANGUAGE_TARGET_STRUCTURAL,
        home_proof_status=HOME_PROOF_COVERED,
        code_section_type="class",
        code_segment_name="parent_class",
        home_proof_refs=(
            "workspaces/aware_kernel/docs/proofs/tests/"
            "test_workspace_sdk_kernel_meta_class_parent_update_public_lifecycle_servicehost.py",
        ),
        notes=(
            "Inheritance augment plans through ClassConfig.update_parent_class "
            "with child/parent scope closure evidence. Python ORM generated "
            "materialization now emits guarded class base-expression text-span "
            "deltas and the public Workspace lifecycle proof applies the "
            "generated CodePackageDelta while preserving source truth."
        ),
    ),
    MetaOcgDeltaCoverageMatrixEntry(
