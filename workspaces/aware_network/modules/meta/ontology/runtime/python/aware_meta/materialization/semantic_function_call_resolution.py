...
META_OCG_IDENTITY_CREATE_FUNCTION = meta_ontology_function_ref(
    ObjectConfigGraphIdentity.create
)
...
META_CLASS_CONFIG_CREATE_COLLECTION_PRIMITIVE_ATTRIBUTE_FUNCTION = (
    meta_ontology_function_ref(ClassConfig.create_collection_primitive_attribute_config)
)
...
META_FUNCTION_CONFIG_ADD_COLLECTION_PRIMITIVE_ATTRIBUTE_FUNCTION = (
    meta_ontology_function_ref(FunctionConfig.add_collection_primitive_attribute_config)
)
...
META_OCG_IDENTITY_CREATE_FUNCTION_REF = META_OCG_IDENTITY_CREATE_FUNCTION.ref
...
META_CLASS_CONFIG_CREATE_COLLECTION_PRIMITIVE_ATTRIBUTE_FUNCTION_REF = (
    META_CLASS_CONFIG_CREATE_COLLECTION_PRIMITIVE_ATTRIBUTE_FUNCTION.ref
)
...
META_FUNCTION_CONFIG_ADD_COLLECTION_PRIMITIVE_ATTRIBUTE_FUNCTION_REF = (
    META_FUNCTION_CONFIG_ADD_COLLECTION_PRIMITIVE_ATTRIBUTE_FUNCTION.ref
)
...
__all__ = [
    ...
    "META_OCG_BUILD_FUNCTION_REF",
    "META_OCG_IDENTITY_CREATE_FUNCTION",
    "META_OCG_IDENTITY_CREATE_FUNCTION_REF",
