...
def _typed_operation_family(*, entry: Mapping[str, object]) -> str:
    operation = _optional_text(entry.get("operation_family"))
        ...
        current.update(
            {
                ...
                "parent_class_id": _optional_text(
                    entry.get("parent_class_id")
                    or entry.get("parent_class_config_id")
                    or payload.get("parent_class_id")
                    or payload.get("parent_class_config_id")
                ),
                "parent_class_fqn": _optional_text(
                    entry.get("parent_class_fqn") or payload.get("parent_class_fqn")
                ),
                "parent_class_semantic_key": _optional_text(
                    entry.get("parent_class_semantic_key")
                    or payload.get("parent_class_semantic_key")
                ),
                "previous_parent_class_id": _optional_text(
                    entry.get("previous_parent_class_id")
                    or payload.get("previous_parent_class_id")
                ),
                "previous_parent_class_fqn": _optional_text(
                    entry.get("previous_parent_class_fqn")
                    or payload.get("previous_parent_class_fqn")
                ),
                "previous_parent_class_semantic_key": _optional_text(
                    entry.get("previous_parent_class_semantic_key")
                    or payload.get("previous_parent_class_semantic_key")
                ),
                "is_base": _bool_value(
                    entry.get("is_base")
                ...
                "semantic_scope_closure_hash": _optional_text(
                    entry.get("semantic_scope_closure_hash")
                ),
                "semantic_scope_closure_ref_keys": _tuple_text(
                    entry.get("semantic_scope_closure_ref_keys")
                ),
                "semantic_scope_closure_gates": _tuple_mapping(
                    entry.get("semantic_scope_closure_gates")
                ),
                "parent_semantic_scope_closure_gate": _mapping_value(
                    entry.get("parent_semantic_scope_closure_gate")
                ),
            }
        )
        ...
        current.update(
            {
                ...
                "relationship_semantic_key": _optional_text(
                    entry.get("relationship_semantic_key")
                    or payload.get("relationship_semantic_key")
                ),
                "association_class_config_id": _optional_text(
                    entry.get("association_class_config_id")
                    or payload.get("association_class_config_id")
                ),
                "relationship_association_id": _optional_text(
                    entry.get("relationship_association_id")
                    or entry.get("association_edge_id")
                    or payload.get("relationship_association_id")
                    or payload.get("association_edge_id")
                ),
                "association_edge_id": _optional_text(
                    entry.get("association_edge_id")
                    or entry.get("relationship_association_id")
                    or payload.get("association_edge_id")
                    or payload.get("relationship_association_id")
                ),
                "attribute_config_id": _optional_text(
                    entry.get("attribute_config_id")
                    or payload.get("attribute_config_id")
                ),
                "relationship_attribute_id": _optional_text(
                    entry.get("relationship_attribute_id")
                    or entry.get("relationship_attribute_config_id")
                    or payload.get("relationship_attribute_id")
                    or payload.get("relationship_attribute_config_id")
                ),
                "relationship_attribute_config_id": _optional_text(
                    entry.get("relationship_attribute_config_id")
                    or entry.get("relationship_attribute_id")
                    or payload.get("relationship_attribute_config_id")
                    or payload.get("relationship_attribute_id")
                ),
                "direction": _optional_text(
                    entry.get("direction") or payload.get("direction")
                ),
                "role": _optional_text(entry.get("role") or payload.get("role")),
                "forward_loading_strategy": _optional_text(
                    entry.get("forward_loading_strategy")
                    or payload.get("forward_loading_strategy")
                ),
                "reverse_loading_strategy": _optional_text(
                    entry.get("reverse_loading_strategy")
                    or payload.get("reverse_loading_strategy")
                ),
                ...
                "relationship_association_signature": _mapping_value(
                    entry.get("relationship_association_signature")
                    or payload.get("relationship_association_signature")
                ),
                "relationship_attribute_signature": _mapping_value(
                    entry.get("relationship_attribute_signature")
                    or payload.get("relationship_attribute_signature")
                ),
                "annotation_semantics_consumed": (
                    entry.get("annotation_semantics_consumed") is True
                ),
                "annotation_semantics_contract_version": _optional_text(
                    entry.get("annotation_semantics_contract_version")
                ),
                "annotation_effect_kind": _optional_text(
                    entry.get("annotation_effect_kind")
                ),
                "annotation_to_relationship_mutation_policy": _optional_text(
                    entry.get("annotation_to_relationship_mutation_policy")
                ),
                "annotation_source_field_path": _optional_text(
                    entry.get("annotation_source_field_path")
                ),
                "semantic_scope_closure_consumed": (
                    entry.get("semantic_scope_closure_consumed") is True
                ),
...
def _tuple_mapping(value: object) -> tuple[dict[str, object], ...]:
