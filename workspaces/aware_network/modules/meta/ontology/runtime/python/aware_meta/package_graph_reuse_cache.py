...
OBJECT_CONFIG_GRAPH_PACKAGE_REUSE_CACHE_KIND_RUNTIME_INDEX_SIDECAR = (
    "meta_graph_context_runtime_index_sidecar"
)
...
def object_config_graph_package_runtime_index_sidecar_cache_path(
    *,
    aware_root: Path,
    branch_id: UUID,
    object_config_graph_package_id: UUID,
    ...
    return base_path.with_name(
        f"{base_path.stem}.runtime_context.index{base_path.suffix}"
    )
...
def read_object_config_graph_package_runtime_index_sidecar_cache_payload(
    *,
    aware_root: Path,
    branch_id: UUID,
    object_config_graph_package_id: UUID,
) -> dict[str, object] | None:
    path = object_config_graph_package_runtime_index_sidecar_cache_path(
        aware_root=aware_root,
        branch_id=branch_id,
        object_config_graph_package_id=object_config_graph_package_id,
    )
...
def write_object_config_graph_package_runtime_index_sidecar_cache_payload(
    *,
    aware_root: Path,
    branch_id: UUID,
    object_config_graph_package_id: UUID,
