    ...
    *,
    ...
    if empty_lane_genesis_execution:
        ...
        with commit_perf_span(
            phase="provider_delta.execution.baseline_hydration",
        ...
        with commit_perf_span(
            phase="provider_delta.execution.initial_head_context",
            category="meta.provider_delta",
        ):
    ...
    with commit_perf_span(
        phase="provider_delta.execution.ontology_invocation",
        category="meta.provider_delta",
