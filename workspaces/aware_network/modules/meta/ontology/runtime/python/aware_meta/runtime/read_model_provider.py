...
class MetaRuntimeReadModelProvider:
    ...
    def read_api_activation(
        ...
        if read_model is None:
            compact_context = _try_build_api_activation_index_only_context(
                repo_root=repo_root,
                aware_root=aware_root,
                required_projection_names=projection_names,
                required_package_names=package_names,
...
def _try_build_api_activation_index_only_context(
    *,
    repo_root: Path,
    aware_root: Path,
    required_projection_names: tuple[str, ...],
    ...
    try:
        return build_meta_graph_runtime_context_for_workspace_required_projections(
            repo_root=repo_root,
            aware_root=aware_root,
