...
def _node_identity_entity(
    ...
    if (
        node_type == ObjectConfigGraphNodeType.class_.value
    ...
    if (
        node_type == ObjectConfigGraphNodeType.enum.value
    ...
    if node_type == ObjectConfigGraphNodeType.function.value:
    ...
    if (
        node_type == ObjectConfigGraphNodeType.relationship.value
...
def _node_type_value(node: ObjectConfigGraphNode) -> str:
