...
def materialize_projection_identities(
    *,
    ...
    can_attach_projection_identities = (
        "object_projection_graph_identities" in ObjectConfigGraphIdentity.model_fields
    )
    ...
    for projection_name in _projection_names(
        ...
        observable_decls = tuple(decl.observables) if decl is not None else ()
...
def _materialize_projection_identity(
    *,
    ...
    is_branchable = (
        bool(declaration.is_branchable) if declaration is not None else False
    )
...
def _materialize_projection_observables(
    *,
    ...
    list[ObjectProjectionGraphObservable],
    list[ProjectionObservableMaterializationRecord],
]:
