...
def test_feature_owned_genesis_helpers_return_typed_value_objects() -> None:
    ...
    assert operation_keys == (
        ...
        (
            ...
            f"{spec.object_projection_graph_declaration_semantic_key}"
        ),
        (
            "meta_ocg.object_projection_graph_binding.create:"
            f"{spec.object_projection_graph_binding_semantic_key}"
        ),
        (
...
def test_feature_registry_includes_package_graph_and_function_handlers() -> None:
    ...
    assert graph_provider.ontology_subject_kinds == (
        "object_config_graph",
...
def _genesis_spec() -> MetaOcgGenesisSpec:
    return MetaOcgGenesisSpec(
        ...
        object_projection_graph_declaration_id=str(
            provider_delta_uuid("feature-owned-genesis-opg-declaration")
        ),
        object_projection_graph_binding_id=str(
            provider_delta_uuid("feature-owned-genesis-opg-binding")
        ),
