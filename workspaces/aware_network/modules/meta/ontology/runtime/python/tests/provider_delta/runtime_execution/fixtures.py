...
def provider_delta_ontology_invocation_runtime_context(
    *,
    ...
    class_update_parent_class = _function_link(
        owner="ClassConfig",
    ...
    relationship_create_association = _function_link(
        owner="ClassConfigRelationship",
        name="create_association",
    )
    relationship_create_attribute = _function_link(
        owner="ClassConfigRelationship",
        name="create_attribute",
    )
    object_projection_graph_create_edge = _function_link(
        owner="ObjectProjectionGraph",
        name="create_edge",
    )
    object_projection_graph_create_constructor = _function_link(
        owner="ObjectProjectionGraph",
        name="create_constructor",
    )
    object_projection_graph_create_relationship = _function_link(
        owner="ObjectProjectionGraph",
        name="create_relationship",
    )
    object_projection_graph_create_object_instance_graph = _function_link(
        owner="ObjectProjectionGraph",
    ...
    index = SimpleNamespace(
        class_configs_by_id={
            ...
            provider_delta_uuid("ClassConfigRelationship.class"): _class_config(
                ...
                function_links=(
                    relationship_update_config,
                    relationship_create_association,
                    relationship_create_attribute,
                ),
            ),
            provider_delta_uuid("ObjectProjectionGraph.class"): _class_config(
                name="ObjectProjectionGraph",
                function_links=(
                    object_projection_graph_create_edge,
                    object_projection_graph_create_constructor,
                    object_projection_graph_create_relationship,
                    object_projection_graph_create_object_instance_graph,
                ),
            ),
