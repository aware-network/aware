...
def test_meta_workflow_closure_blocks_missing_service_native_function_refs() -> None:
    ...
    result = resolve_meta_semantic_workflow_closure(
        semantic_contracts=(_service_contract_fixture(),),
        catalog=catalog,
...
def _service_contract_fixture() -> ModuleSemanticContract:
    return ModuleSemanticContract(
        provider_key="aware_service",
        semantic_workflows=(
            ModuleSemanticWorkflowDescriptor(
                workflow_key="external-api-service.service",
                semantic_owner="aware_service.provider",
                stage_keys=(
                ...
                ontology_feature_refs=SERVICE_ONTOLOGY_FEATURE_REFS,
                graph_binding_refs=SERVICE_GRAPH_BINDING_REFS,
                expected_proof_refs=(
                    "api_service_protocol.hash",
                    "workspace.semantic_materialization.receipt",
                    "meta.function_call.proof",
        ...
        materialization_runtime=(
            ModuleSemanticMaterializationRuntimeDescriptor(
                semantic_owner="aware_service.provider",
                runtime_ontology_package_names=("service-ontology",),
