...
from _meta_runtime_test_paths import META_FIXTURES_ROOT
...
def test_home_story_runtime_relationship_nodes_are_in_runtime_preview_keys() -> None:
    ...
    assert affected_relationship_keys == (
        "ocg:aware_home/node:aware_home.home.Home:doors:one_to_many:aware_home.home.Door",
        "ocg:aware_home/node:aware_home.home.Home:tvs:one_to_many:aware_home.home.Tv",
    )
