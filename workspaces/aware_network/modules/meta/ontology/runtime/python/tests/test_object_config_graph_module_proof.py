...
ENUM_CONFIG_FQN = "aware_meta.enum.EnumConfig"
...
async def test_object_config_graph_module_proof(tmp_path: Path) -> None:
    ...
    lane = LaneIds(
        branch_id=uuid5(NAMESPACE_URL, "aware://tests/meta/ocg/branch"),
        actor_id=uuid5(NAMESPACE_URL, "aware://tests/meta/ocg/actor"),
    )
