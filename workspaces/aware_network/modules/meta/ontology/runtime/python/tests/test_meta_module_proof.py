...
FUNCTION_CALL_FQN = "aware_meta.function.FunctionCall"
...
async def test_meta_module_proof_projection_identity_observable(
    ...
    with IsolatedAwareRoot(
        ...
        lane = LaneIds(
            branch_id=uuid5(NAMESPACE_URL, "meta://tests/projection_identity/branch"),
            actor_id=uuid5(NAMESPACE_URL, "meta://tests/projection_identity/actor"),
        )
