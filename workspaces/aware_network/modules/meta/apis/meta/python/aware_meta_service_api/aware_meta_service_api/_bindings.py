        ...
        "apis": [
            {
                "capabilities": [
                    ...
                    },
                    {
                        "endpoints": [
                            {
                                "description": "Select one identity in the Meta graph "
                                "canvas and request view-state refresh "
                                "coordinates.",
                                "discriminant": "meta.view_action.select_identity",
                                "name": "select_identity",
                                "request": {
                                    "class_ref": "aware_meta_service_dto.graph.view.MetaGraphSelectIdentityViewActionRequest",
                                    "source_path": "bindings/meta.apis.aware",
                                },
                                "response": {
                                    "class_ref": "aware_meta_service_dto.graph.view.MetaGraphSelectIdentityViewActionResponse",
                                    "source_path": "bindings/meta.apis.aware",
                                },
                                "source_path": "bindings/meta.apis.aware",
                            }
                        ...
                        "endpoints": [
                            {
                                ...
                                "coordinates.",
                                "discriminant": "meta.view_action.select_identity",
                                "endpoint_ref": "meta.view_action.select_identity",
                                "fulfillment_bindings": [],
                                "invocation_kind": "shared_client_endpoint",
                                "name": "select_identity",
                                "request": {
                                    "class_ref": "aware_meta_service_dto.graph.view.MetaGraphSelectIdentityViewActionRequest",
                                    "python_model_ref": "aware_meta_service_dto.graph.view.graph_view.MetaGraphSelectIdentityViewActionRequest",
                                    "source_path": "bindings/meta.apis.aware",
                                },
                                "response": {
                                    "class_ref": "aware_meta_service_dto.graph.view.MetaGraphSelectIdentityViewActionResponse",
                                    "python_model_ref": "aware_meta_service_dto.graph.view.graph_view.MetaGraphSelectIdentityViewActionResponse",
                                    "source_path": "bindings/meta.apis.aware",
                                },
                                "source_path": "bindings/meta.apis.aware",
                            }
...
ENDPOINT_REF_BY_NAME: Final[dict[str, str]] = {
    ...
    "meta.view_action.select_identity": META__VIEW_ACTION__SELECT_IDENTITY_ENDPOINT_REF,
}
