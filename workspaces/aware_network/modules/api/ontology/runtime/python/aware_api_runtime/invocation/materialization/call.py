...
from aware_utils.pydantic.class_config_registry import (
    get_pydantic_package_class_config_payload,
    ...
    *,
    ...
    trace_fields = {
        ...
        "request_class_config_id": (
            str(ir.request_class_config_id)
            if ir.request_class_config_id is not None
            else None
        ),
        "source_branch_id": str(source_lane.branch_id),
        "target_branch_id": str(target_lane.branch_id),
        "target_projection_hash": target_lane.projection_hash,
        "commit": commit,
        "publish": publish,
    }
    logger.info(
    ...
    request_contract = await await_with_api_invocation_trace(
        ...
        phase="api_invocation.materialize_api_call.resolve_request_contract",
        fields=trace_fields,
    )
    logger.info(
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.resolve_target_lane",
        **trace_fields,
    ):
    ...
    runtime_lane = await await_with_api_invocation_trace(
        _resolve_runtime_lane(
            runtime=runtime,
            lane=effective_target_lane,
            actor_id=actor_id,
        ),
        phase="api_invocation.materialize_api_call.resolve_runtime_lane",
        fields=trace_fields,
        effective_target_branch_id=str(effective_target_lane.branch_id),
    )
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.resolve_receipt_payload_mode",
        receipt_projection_backend=_receipt_projection_backend_name(
    ...
    with api_invocation_trace_phase(
        ...
        compact_receipt_payload=use_compact_receipt_payload,
        effective_target_branch_id=str(effective_target_lane.branch_id),
        **trace_fields,
    ):
        with runtime_lane.activate(commit=commit, publish=publish):
            ...
            with api_invocation_trace_phase(
                "api_invocation.materialize_api_call.request_class_config_closure",
                compact_receipt_payload=use_compact_receipt_payload,
                **trace_fields,
            ):
            ...
            with scoped_api_call_materialization_input(
                ...
                request_hash=compact_request_hash,
            ):
                with api_invocation_trace_phase(
                    "api_invocation.materialize_api_call.invoke_create_handler",
                    **trace_fields,
                ):
    ...
    if hydrated_api_call.request_model is None:
        ...
        hydrated_api_call = await await_with_api_invocation_trace(
            ...
            phase="api_invocation.materialize_api_call.hydrate_materialized_api_call",
            fields=trace_fields,
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.build_result",
        api_call_id=str(api_call_id),
        **trace_fields,
    ):
...
async def _resolve_api_endpoint_request_contract(
    *,
    ...
    trace_fields = _request_contract_trace_fields(
        ir=ir,
        source_lane=source_lane,
    ...
    if source_commit is None:
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.resolve_source_head",
            **trace_fields,
        ):
        ...
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.use_source_commit",
            source_commit_id=str(source_commit.commit_id),
            **trace_fields,
        ):
    ...
    if ir.api_capability_endpoint_id is not None:
        endpoint = await await_with_api_invocation_trace(
            ...
            phase=(
                "api_invocation.materialize_api_call."
                "request_contract.explicit_endpoint_hydrate"
            ),
            fields=trace_fields,
            endpoint_id=str(ir.api_capability_endpoint_id),
        )
        if endpoint is None:
            raise RuntimeError(
        ...
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.explicit_endpoint_validate",
            endpoint_id=str(ir.api_capability_endpoint_id),
            **trace_fields,
        ):
            _validate_explicit_endpoint_identity(endpoint=endpoint, ir=ir)
        return await await_with_api_invocation_trace(
            _resolve_endpoint_request_contract_from_endpoint(
                index=index,
                endpoint=endpoint,
                ir=ir,
            ),
            phase=(
                "api_invocation.materialize_api_call."
                "request_contract.from_explicit_endpoint"
            ),
            fields=trace_fields,
            endpoint_id=str(ir.api_capability_endpoint_id),
        )
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.verified_ir",
        **trace_fields,
    ):
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.derive_endpoint_identity",
        **trace_fields,
    ):
    ...
    endpoint = await await_with_api_invocation_trace(
        ...
        phase=(
            "api_invocation.materialize_api_call."
            "request_contract.derived_endpoint_hydrate"
        ),
        fields=trace_fields,
        endpoint_id=str(endpoint_id),
    )
    if endpoint is None:
        api_root = await await_with_api_invocation_trace(
            _hydrate_source_api_root(
                index=index,
                source_branch_id=source_branch_id,
                source_projection_hash=source_projection_hash,
                source_commit_id=source_commit_id,
            ...
            phase=(
                "api_invocation.materialize_api_call."
                "request_contract.api_root_fallback_hydrate"
            ),
            fields=trace_fields,
            api_id=str(api_id),
        )
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.api_root_fallback_search",
            api_id=str(api_id),
            **trace_fields,
        ):
            endpoint = (
    ...
    return await await_with_api_invocation_trace(
        ...
        phase=(
            "api_invocation.materialize_api_call."
            "request_contract.from_derived_endpoint"
        ),
        fields=trace_fields,
        endpoint_id=str(endpoint_id),
    )
...
def _request_contract_trace_fields(
    *,
    ir: ApiInvocationIR,
    source_lane: MaterializationLaneContext,
    ...
    return {
        ...
        "source_branch_id": str(source_lane.branch_id),
        "source_projection_hash": source_lane.projection_hash,
        "fulfillment_binding_count": len(ir.fulfillment_bindings),
        "require_endpoint": require_endpoint,
    }
...
async def _hydrate_source_api_endpoint(
    *,
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.hydrate_endpoint.opg_lookup",
        **trace_fields,
    ):
    ...
    source_oig, _ = await await_with_api_invocation_trace(
        ...
        phase=(
            "api_invocation.materialize_api_call."
            "request_contract.hydrate_endpoint.materializer_get"
        ),
        fields=trace_fields,
    )

    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.hydrate_endpoint.reify_model",
        **trace_fields,
    ):
...
async def _hydrate_source_api_root(
    *,
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.hydrate_api_root.opg_lookup",
        **trace_fields,
    ):
        opg = index.opg_by_hash.get(source_projection_hash)
        if opg is None:
    ...
    source_oig, _ = await await_with_api_invocation_trace(
        ...
        phase=(
            "api_invocation.materialize_api_call."
            "request_contract.hydrate_api_root.materializer_get"
        ),
        fields=trace_fields,
    )

    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.hydrate_api_root.reify_model",
        **trace_fields,
    ):
        return reify_oig_root_model(
            index=index,
...
async def _resolve_endpoint_request_contract_from_endpoint(
    *,
    ...
    trace_fields = _endpoint_request_contract_trace_fields(endpoint=endpoint, ir=ir)
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.endpoint.request_config",
        **trace_fields,
    ):
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.endpoint.registered_pydantic_lookup",
        request_config_class_config_id=str(request_config.class_config_id),
        **trace_fields,
    ):
    ...
    if request_class_config is None:
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.endpoint.portal_class_config",
            request_config_class_config_id=str(request_config.class_config_id),
            **trace_fields,
        ):
    ...
    if request_class_config is None:
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.endpoint.runtime_index_lookup",
            request_config_class_config_id=str(request_config.class_config_id),
            **trace_fields,
        ):
    ...
    if request_class_config is None:
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.endpoint.orm_registry_lookup",
            request_config_class_config_id=str(request_config.class_config_id),
            **trace_fields,
        ):
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.endpoint.validate",
        request_config_class_config_id=str(request_config.class_config_id),
        resolved_request_class_config_id=(
            str(request_class_config.id)
            if request_class_config is not None and request_class_config.id is not None
            else None
        ),
        **trace_fields,
    ):
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.endpoint.fulfillment_bindings",
        request_config_class_config_id=str(request_config.class_config_id),
        **trace_fields,
    ):
...
def _resolve_verified_ir_endpoint_request_contract(
    *,
    ...
    trace_fields = _verified_ir_trace_fields(ir=ir)
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.verified_ir.fulfillment_guard",
        **trace_fields,
    ):
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.verified_ir.request_class_config",
        **trace_fields,
    ):
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.verified_ir.endpoint_identity",
        resolved_request_class_config_id=str(request_class_config.id),
        **trace_fields,
    ):
        api_id = stable_api_id(name=ir.api_name)
        capability_id = stable_api_capability_id(
...
def _resolve_verified_ir_request_class_config(
    *,
    ...
    if request_class_config_id is not None:
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.verified_ir.registered_pydantic_lookup",
            request_class_config_id=str(request_class_config_id),
            **_verified_ir_trace_fields(ir=ir),
        ):
            request_class_config = _resolve_registered_pydantic_request_class_config(
                ir=ir,
                request_class_config_id=request_class_config_id,
        ...
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.verified_ir.runtime_index_lookup",
            request_class_config_id=str(request_class_config_id),
            **_verified_ir_trace_fields(ir=ir),
        ):
            request_class_config = index.class_configs_by_id.get(
        ...
        if request_class_config is None:
            with api_invocation_trace_phase(
                "api_invocation.materialize_api_call.request_contract.verified_ir.orm_registry_lookup",
                request_class_config_id=str(request_class_config_id),
                **_verified_ir_trace_fields(ir=ir),
            ):
                orm_class = ORMModelRegistry.get_class_by_class_config_id(
...
def _resolve_registered_pydantic_request_class_config(
    *,
    ...
    if package_prefix:
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.pydantic.package_register",
            **trace_fields,
        ):
    ...
    if request_class_config_id is not None:
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.pydantic.package_payload_lookup",
            **trace_fields,
        ):
            package_payload = get_pydantic_package_class_config_payload(
                package_prefix=package_prefix,
                class_config_id=str(request_class_config_id),
            )
        if package_payload is not None:
            with api_invocation_trace_phase(
                "api_invocation.materialize_api_call.request_contract.pydantic.package_payload_validate",
                **trace_fields,
            ):
                request_class_config = ClassConfig.model_validate(package_payload)
            if request_class_config.id != request_class_config_id:
                return None
            return request_class_config

        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.pydantic.iter_package_class_configs",
            **trace_fields,
        ):
            package_class_configs = _iter_package_class_configs(
                package_prefix=package_prefix,
            )
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.pydantic.match_package_class_configs",
            package_class_config_count=len(package_class_configs),
            **trace_fields,
        ):
            for class_config in package_class_configs:
                if class_config.id == request_class_config_id:
                    return class_config

        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.pydantic.registered_payload_lookup",
            **trace_fields,
        ):
        ...
        if payload is None:
            return None
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.pydantic.payload_validate",
            **trace_fields,
        ):
    ...
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.pydantic.iter_entries",
    ...
    if not entries:
        with api_invocation_trace_phase(
            "api_invocation.materialize_api_call.request_contract.pydantic.iter_all_registered_entries",
            class_name=class_name,
            **trace_fields,
        ):
            entries = tuple(iter_registered_class_config_payloads())
    with api_invocation_trace_phase(
        "api_invocation.materialize_api_call.request_contract.pydantic.match_payloads",
        class_name=class_name,
        ...
        **trace_fields,
        ...
        for entry in entries:
            ...
            if (
                package_prefix
                and source
                and not source.startswith(package_prefix + "/")
            ):
                continue
...
def _endpoint_request_contract_trace_fields(
    *,
    endpoint: ApiCapabilityEndpoint,
    ir: ApiInvocationIR,
) -> dict[str, object]:
    return {
        "endpoint_ref": ir.endpoint_ref,
        "endpoint_id": str(endpoint.id) if endpoint.id is not None else None,
        "request_class_ref": ir.request_class_ref,
        "request_class_config_id": (
            str(ir.request_class_config_id)
            if ir.request_class_config_id is not None
...
def _verified_ir_trace_fields(*, ir: ApiInvocationIR) -> dict[str, object]:
    return {
        "endpoint_ref": ir.endpoint_ref,
        "request_class_ref": ir.request_class_ref,
        "fulfillment_binding_count": len(ir.fulfillment_bindings),
