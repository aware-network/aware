...
@dataclass(frozen=True, slots=True)
class APIViewStreamPolicyOwnership:
    stream_mode: str
    source_path: str
    description: str | None = None
...
@dataclass(frozen=True, slots=True)
class APIViewCapabilityEndpointOwnership:
    action_key: str
    endpoint_ref: str
    source_path: str
    description: str | None = None
...
class APIViewOwnership:
    ...
    capability_endpoints: tuple[APIViewCapabilityEndpointOwnership, ...] = ()
    description: str | None = None
