...
META_PYTHON_ORM_ENUM_GENERATED_MATERIALIZATION_PRODUCT_INTENT = (
    ORM_RUNTIME_PRODUCT_INTENT
)
...
def _context_with_defaults(
    ...
    normalized_context = _python_orm_enum_context(
        MetaProviderDeltaGeneratedMaterializationContext(
    ...
    return MetaPythonOrmEnumGeneratedMaterializationContext(
        ...
        materialization_source=(
            ...
            or META_PYTHON_ORM_ENUM_MATERIALIZATION_SOURCE
        ),
