...
def _external_python_type_index_payload(
    *, graph: ObjectConfigGraph
    ...
    classes_by_fqn = {
        str(node.class_config.class_fqn): node.class_config
    ...
    return {
        "language": "python",
        "classes": {
            str(classes_by_fqn["aware_home.home.Door"].id): {
                "module": "aware_home_ontology.home.door",
                "name": "Door",
                "class_ref": "aware_home.home.Door",
            },
            str(classes_by_fqn["aware_home_api.door.DoorSnapshot"].id): {
                "module": "aware_home_api.door.endpoints",
                "name": "DoorSnapshot",
                "class_ref": "aware_home_api.door.DoorSnapshot",
            },
            str(classes_by_fqn["aware_home_api.door.LockDoor"].id): {
                "module": "aware_home_api.door.endpoints",
                "name": "LockDoor",
                "class_ref": "aware_home_api.door.LockDoor",
            },
            str(classes_by_fqn["aware_home_api.door.LockDoorResult"].id): {
                "module": "aware_home_api.door.endpoints",
                "name": "LockDoorResult",
...
def test_api_service_protocol_renderer_emits_protocol_surface_without_dto_family(
    ...
    assert "from aware_home_story_api.models.lock_door import LockDoor" not in text
    assert (
        "from aware_home_story_api.models.lock_door_result import LockDoorResult"
        not in text
    )
    assert (
        "from aware_home_story_api.models.door_snapshot import DoorSnapshot" not in text
    )
