...
def _semantic_contract_for_rule(
    *,
    provider_key: str,
    semantic_owner: str,
    grammar_rule: str,
    ...
    return ModuleSemanticContract(
        ...
        syntax_lanes=(
            ModuleSemanticSyntaxLaneDescriptor(
                lane_key=f"{provider_key}.{grammar_rule}",
                semantic_owner=semantic_owner,
                compiler_owner=semantic_owner,
