...
def function_io_owner_key(
    function_config: FunctionConfig, attr_type: FunctionAttributeType | str
) -> str:
    type_value = (
        attr_type.value
        if isinstance(attr_type, FunctionAttributeType)
        else str(attr_type)
    )
...
def make_class(
    ...
    **kwargs,
    ...
    return ClassConfig(
        name=name,
        class_fqn=class_fqn(name, package=package, namespace=namespace),
        **kwargs,
    )
...
def make_enum(
    ...
    **kwargs,
    ...
    return EnumConfig(
        name=name,
        enum_fqn=enum_fqn(name, package=package, namespace=namespace),
        **kwargs,
    )
