...
class CodeServiceRequest(BaseModel):
    ...
    _TAG_TO_TYPE: ClassVar[dict[str, str]] = {
        ...
        "resolve_code_package_selector_view": "aware_code_service_dto.code.features.view_state.ResolveCodePackageSelectorViewRequest",
        "resolve_code_editor_view": "aware_code_service_dto.code.features.view_state.ResolveCodeEditorViewRequest",
        "select_code_view_action": "aware_code_service_dto.code.features.view_state.SelectCodeViewActionRequest",
        ...
        "select_code_section_view_action": "aware_code_service_dto.code.features.view_state.SelectCodeSectionViewActionRequest",
...
class CodeServiceResponse(BaseModel):
    ...
    _TAG_TO_TYPE: ClassVar[dict[str, str]] = {
        ...
        "resolve_code_package_selector_view": "aware_code_service_dto.code.features.view_state.ResolveCodePackageSelectorViewResponse",
        "resolve_code_editor_view": "aware_code_service_dto.code.features.view_state.ResolveCodeEditorViewResponse",
        "select_code_view_action": "aware_code_service_dto.code.features.view_state.SelectCodeViewActionResponse",
        "select_code_section_view_action": "aware_code_service_dto.code.features.view_state.SelectCodeSectionViewActionResponse",
