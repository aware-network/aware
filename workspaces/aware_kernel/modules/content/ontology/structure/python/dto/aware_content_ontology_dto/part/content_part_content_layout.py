...
from aware_content_ontology_dto.part.content_part_enums import ContentPartLayoutUnit

if TYPE_CHECKING:
    from aware_content_ontology_dto.part.content_part_content import ContentPartContent


class ContentPartContentLayout(BaseModel):
    # Relationships
    content_part_content: ContentPartContent | None = Field(
        default=None, description="Association target reference to ContentPartContent"
    )
