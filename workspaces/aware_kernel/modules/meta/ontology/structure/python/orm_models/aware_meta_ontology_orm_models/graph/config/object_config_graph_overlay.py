...
if TYPE_CHECKING:
    ...
    from aware_meta_ontology_orm_models.attribute.attribute_config_overlay import AttributeConfigOverlay
    from aware_meta_ontology_orm_models.class_.class_config import ClassConfig
    from aware_meta_ontology_orm_models.class_.class_config_overlay import ClassConfigOverlay
    from aware_meta_ontology_orm_models.enum.enum_config import EnumConfig
    from aware_meta_ontology_orm_models.enum.enum_config_overlay import EnumConfigOverlay
    from aware_meta_ontology_orm_models.enum.enum_option import EnumOption
    from aware_meta_ontology_orm_models.enum.enum_option_overlay import EnumOptionOverlay
    from aware_meta_ontology_orm_models.function.function_config import FunctionConfig
    from aware_meta_ontology_orm_models.function.function_config_overlay import FunctionConfigOverlay
