...
class ObjectConfigGraphPackageBuild(ORMModel):
    """
    ...
    # Relationships
    object_config_graph_package: ObjectConfigGraphPackage | None = Field(default=None, exclude=True)
    ...
    object_config_graph_package_id: UUID = Field(
        description="Foreign key for ObjectConfigGraphPackageBuild.object_config_graph_package"
    )
