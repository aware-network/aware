...
if TYPE_CHECKING:
    ...
    from aware_meta_ontology_dto.graph.config.object_config_graph_package_language_materialization_package import (
        ObjectConfigGraphPackageLanguageMaterializationPackage,
    )


class ObjectConfigGraphPackageLanguageMaterialization(BaseModel):
    """
    ...
    object_config_graph_package: ObjectConfigGraphPackage | None = Field(
        default=None, description="Reverse view for ObjectConfigGraphPackage.language_materializations"
    )
