...
CREATE TABLE object_config_graph_annotation (
  ...
  code_section_annotation_discriminate_id TEXT,
  code_section_annotation_load_id TEXT,
  code_section_annotation_overlay_id TEXT,
  code_section_annotation_override_id TEXT,
  code_section_annotation_oneof_id TEXT,
  code_section_annotation_identity_id TEXT,
  code_section_annotation_reference_id TEXT,
  code_section_annotation_index_id TEXT,
  code_section_annotation_storage_id TEXT,
  -- ATTRIBUTES
  kind TEXT NOT NULL,
  -- CONSTRAINTS
