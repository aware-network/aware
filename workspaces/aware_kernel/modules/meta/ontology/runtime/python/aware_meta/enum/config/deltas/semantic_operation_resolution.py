...
def _enum_create_values_from_siblings(
    *,
    ...
    for index, candidate in enumerate(operation_group):
        ...
        values_by_position.append((position if position is not None else index, index, value))
        seen.add(value)
        ...
        intent.update(
            {
                ...
                "policy_key": "aware_meta.python_orm.enum.create",
                "materialization_target": "python_enum_class",
            }
        )
    metadata: dict[str, object] = {
    ...
    *,
    ...
    if ready:
        intent.update(
            {
                "renderer_key": "python.orm.enum",
                "policy_key": "aware_meta.python_orm.enum.delete",
                "materialization_target": "python_enum_class",
            }
        )
    metadata: dict[str, object] = {
        ...
        intent.update(
            {
                ...
                "materialization_target": "python_enum_docstring",
            }
        )
    metadata: dict[str, object] = {
        "generated_materialization_intent_status": status,
