# aware_meta_service_api

Generated API client package.

Public generated API client and service protocol boundary for Meta Graph-OS commit authority and commit fan-out.

## Install

```bash
pip install aware-meta-service-api
```
...
api = AwareMetaServiceApiClient(AwareApiEndpointInvoker(...))
```
