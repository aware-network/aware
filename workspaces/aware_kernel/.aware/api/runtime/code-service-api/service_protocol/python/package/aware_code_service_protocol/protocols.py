...
from aware_code_service_dto.code.features.view_state import (
    ...
    SelectCodeSectionViewActionRequest,
    SelectCodeSectionViewActionResponse,
    SelectCodeViewActionRequest,
    SelectCodeViewActionResponse,
)
...
async def invoke_code__view_action__select_code(
    handler: object, request: BaseModel, execution: ServiceProtocolExecution | None = None
) -> SelectCodeViewActionResponse:
    typed_handler = cast(AwareCodeServiceProtocol, handler)
    typed_request = SelectCodeViewActionRequest.model_validate(request)
    return await typed_handler.code.view_action.select_code(typed_request)


CODE__VIEW_ACTION__SELECT_CODE_ENDPOINT_REF: Final[str] = "code.view_action.select_code"
CODE__VIEW_ACTION__SELECT_CODE_PROTOCOL_BINDING: Final[ServiceProtocolEndpointBinding] = ServiceProtocolEndpointBinding(
    endpoint_ref=CODE__VIEW_ACTION__SELECT_CODE_ENDPOINT_REF,
    api_name="code",
    capability_name="view_action",
    endpoint_name="select_code",
    request_type_ref="aware_code_service_dto.code.SelectCodeViewActionRequest",
    response_type_ref="aware_code_service_dto.code.SelectCodeViewActionResponse",
    stream_event_type_refs=(),
    execution_protocol_ref=None,
    build_execution=None,
    stream_invoke=None,
    fulfillment_bindings=(),
    invoke=invoke_code__view_action__select_code,
)


async def invoke_code__view_action__select_section(
    handler: object, request: BaseModel, execution: ServiceProtocolExecution | None = None
) -> SelectCodeSectionViewActionResponse:
    typed_handler = cast(AwareCodeServiceProtocol, handler)
    typed_request = SelectCodeSectionViewActionRequest.model_validate(request)
    return await typed_handler.code.view_action.select_section(typed_request)


CODE__VIEW_ACTION__SELECT_SECTION_ENDPOINT_REF: Final[str] = "code.view_action.select_section"
CODE__VIEW_ACTION__SELECT_SECTION_PROTOCOL_BINDING: Final[ServiceProtocolEndpointBinding] = (
    ServiceProtocolEndpointBinding(
        endpoint_ref=CODE__VIEW_ACTION__SELECT_SECTION_ENDPOINT_REF,
        api_name="code",
        capability_name="view_action",
        endpoint_name="select_section",
        request_type_ref="aware_code_service_dto.code.SelectCodeSectionViewActionRequest",
        response_type_ref="aware_code_service_dto.code.SelectCodeSectionViewActionResponse",
        stream_event_type_refs=(),
        execution_protocol_ref=None,
        build_execution=None,
        stream_invoke=None,
        fulfillment_bindings=(),
        invoke=invoke_code__view_action__select_section,
    )
)


async def invoke_code__view_state__resolve_editor(
    handler: object, request: BaseModel, execution: ServiceProtocolExecution | None = None
) -> ResolveCodeEditorViewResponse:
    typed_handler = cast(AwareCodeServiceProtocol, handler)
    typed_request = ResolveCodeEditorViewRequest.model_validate(request)
    return await typed_handler.code.view_state.resolve_editor(typed_request)


CODE__VIEW_STATE__RESOLVE_EDITOR_ENDPOINT_REF: Final[str] = "code.view_state.resolve_editor"
CODE__VIEW_STATE__RESOLVE_EDITOR_PROTOCOL_BINDING: Final[ServiceProtocolEndpointBinding] = (
    ServiceProtocolEndpointBinding(
        endpoint_ref=CODE__VIEW_STATE__RESOLVE_EDITOR_ENDPOINT_REF,
        api_name="code",
        capability_name="view_state",
        endpoint_name="resolve_editor",
        request_type_ref="aware_code_service_dto.code.ResolveCodeEditorViewRequest",
        response_type_ref="aware_code_service_dto.code.ResolveCodeEditorViewResponse",
        stream_event_type_refs=(),
        execution_protocol_ref=None,
        build_execution=None,
        stream_invoke=None,
        fulfillment_bindings=(),
        invoke=invoke_code__view_state__resolve_editor,
    )
)


async def invoke_code__view_state__resolve_package_selector(
    handler: object, request: BaseModel, execution: ServiceProtocolExecution | None = None
) -> ResolveCodePackageSelectorViewResponse:
    typed_handler = cast(AwareCodeServiceProtocol, handler)
    typed_request = ResolveCodePackageSelectorViewRequest.model_validate(request)
    return await typed_handler.code.view_state.resolve_package_selector(typed_request)


CODE__VIEW_STATE__RESOLVE_PACKAGE_SELECTOR_ENDPOINT_REF: Final[str] = "code.view_state.resolve_package_selector"
CODE__VIEW_STATE__RESOLVE_PACKAGE_SELECTOR_PROTOCOL_BINDING: Final[ServiceProtocolEndpointBinding] = (
    ServiceProtocolEndpointBinding(
        endpoint_ref=CODE__VIEW_STATE__RESOLVE_PACKAGE_SELECTOR_ENDPOINT_REF,
        api_name="code",
        capability_name="view_state",
        endpoint_name="resolve_package_selector",
        request_type_ref="aware_code_service_dto.code.ResolveCodePackageSelectorViewRequest",
        response_type_ref="aware_code_service_dto.code.ResolveCodePackageSelectorViewResponse",
        stream_event_type_refs=(),
        execution_protocol_ref=None,
        build_execution=None,
        stream_invoke=None,
        fulfillment_bindings=(),
        invoke=invoke_code__view_state__resolve_package_selector,
    )
)
...
ENDPOINT_BINDINGS: Final[dict[str, ServiceProtocolEndpointBinding]] = {
    ...
    CODE__VIEW_ACTION__SELECT_CODE_ENDPOINT_REF: CODE__VIEW_ACTION__SELECT_CODE_PROTOCOL_BINDING,
    CODE__VIEW_ACTION__SELECT_SECTION_ENDPOINT_REF: CODE__VIEW_ACTION__SELECT_SECTION_PROTOCOL_BINDING,
    CODE__VIEW_STATE__RESOLVE_EDITOR_ENDPOINT_REF: CODE__VIEW_STATE__RESOLVE_EDITOR_PROTOCOL_BINDING,
    CODE__VIEW_STATE__RESOLVE_PACKAGE_SELECTOR_ENDPOINT_REF: CODE__VIEW_STATE__RESOLVE_PACKAGE_SELECTOR_PROTOCOL_BINDING,
}
...
class CodeViewActionCapabilityServiceProtocol(Protocol):

    async def select_code(self, request: SelectCodeViewActionRequest) -> SelectCodeViewActionResponse: ...

    async def select_section(
        self, request: SelectCodeSectionViewActionRequest
    ) -> SelectCodeSectionViewActionResponse: ...


class CodeViewStateCapabilityServiceProtocol(Protocol):

    async def resolve_editor(self, request: ResolveCodeEditorViewRequest) -> ResolveCodeEditorViewResponse: ...

    async def resolve_package_selector(
        self, request: ResolveCodePackageSelectorViewRequest
    ) -> ResolveCodePackageSelectorViewResponse: ...
...
class CodeApiServiceProtocol(Protocol):
    ...
    view_action: CodeViewActionCapabilityServiceProtocol
    view_state: CodeViewStateCapabilityServiceProtocol
...
SERVICE_PROTOCOL_RENDER_SECTION_MANIFEST_JSON: Final[str] = (
    ...
    '  "described_sections_text_digest": "sha256:b1dae89f54186a7ad3d9ce3f692c49563a0bf427630e9a1736edf834ec0de063",'
    ...
    "    {"
    '      "line_count": 29,'
    '      "rendered_text_digest": "sha256:f7eca34682910bb2ddc11a14b1708c57f61af4ed26d3be775af87e446fed0230",'
    ...
    '      "line_count": 0,'
    '      "rendered_text_digest": "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",'
    '      "section_key": "api.service_protocol.endpoint_execution:code.view_action.select_code",'
    '      "section_kind": "service_protocol_endpoint_execution",'
    '      "section_order": 34'
    "    },"
    "    {"
    '      "line_count": 0,'
    '      "rendered_text_digest": "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",'
    '      "section_key": "api.service_protocol.endpoint_execution:code.view_action.select_section",'
    '      "section_kind": "service_protocol_endpoint_execution",'
    '      "section_order": 35'
    "    },"
    "    {"
    '      "line_count": 0,'
    '      "rendered_text_digest": "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",'
    '      "section_key": "api.service_protocol.endpoint_execution:code.view_state.resolve_editor",'
    '      "section_kind": "service_protocol_endpoint_execution",'
    '      "section_order": 36'
    "    },"
    "    {"
    '      "line_count": 0,'
    '      "rendered_text_digest": "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",'
    '      "section_key": "api.service_protocol.endpoint_execution:code.view_state.resolve_package_selector",'
    '      "section_kind": "service_protocol_endpoint_execution",'
    '      "section_order": 37'
    "    },"
    "    {"
    ...
    "    {"
    '      "line_count": 5,'
    '      "rendered_text_digest": "sha256:645c2011770b899a01be6b187df0e80f6f8d142e22122268e1de46d701fd2acd",'
    '      "section_key": "api.service_protocol.endpoint_invoker:code.view_action.select_code",'
    '      "section_kind": "service_protocol_endpoint_invoker",'
    '      "section_order": 102'
    "    },"
    "    {"
    '      "line_count": 18,'
    '      "rendered_text_digest": "sha256:fb48df946a88d55e861be77647865a985c1388a9149fd658ea559e106f283418",'
    '      "section_key": "api.service_protocol.endpoint_binding:code.view_action.select_code",'
    '      "section_kind": "service_protocol_endpoint_binding",'
    '      "section_order": 103'
    "    },"
    "    {"
    '      "line_count": 5,'
    '      "rendered_text_digest": "sha256:275ce6a79cfa45b238f90ae01e6d9be67592de0ac2543df8b3179c990992e4a0",'
    '      "section_key": "api.service_protocol.endpoint_invoker:code.view_action.select_section",'
    '      "section_kind": "service_protocol_endpoint_invoker",'
    '      "section_order": 104'
    "    },"
    "    {"
    '      "line_count": 18,'
    '      "rendered_text_digest": "sha256:cdfed59962d2ba3021f7a8d58849807ee70e2c25a18f5bbff1908c4ddc8bf156",'
    '      "section_key": "api.service_protocol.endpoint_binding:code.view_action.select_section",'
    '      "section_kind": "service_protocol_endpoint_binding",'
    '      "section_order": 105'
    "    },"
    "    {"
    '      "line_count": 5,'
    '      "rendered_text_digest": "sha256:9b2331e1a6bf2d5b230be9524228642d6cc769ed122fd09591abc7222cfbbe4c",'
    '      "section_key": "api.service_protocol.endpoint_invoker:code.view_state.resolve_editor",'
    '      "section_kind": "service_protocol_endpoint_invoker",'
    '      "section_order": 106'
    "    },"
    "    {"
    '      "line_count": 18,'
    '      "rendered_text_digest": "sha256:739d7b8019f4411cd1955394a55eef38ed7a31350f5d296097a32be61d7e97fb",'
    '      "section_key": "api.service_protocol.endpoint_binding:code.view_state.resolve_editor",'
    '      "section_kind": "service_protocol_endpoint_binding",'
    '      "section_order": 107'
    "    },"
    "    {"
    '      "line_count": 5,'
    '      "rendered_text_digest": "sha256:1c5626b545dbe95eaf77229d2f6688ef6bdf6ac7080d0851ccfece622da0f83c",'
    '      "section_key": "api.service_protocol.endpoint_invoker:code.view_state.resolve_package_selector",'
    '      "section_kind": "service_protocol_endpoint_invoker",'
    '      "section_order": 108'
    "    },"
    "    {"
    '      "line_count": 18,'
    '      "rendered_text_digest": "sha256:02b18aed7da1055df84eafd516301ce833b2eea08ffe6ea7d264c7bcf81b0b9b",'
    '      "section_key": "api.service_protocol.endpoint_binding:code.view_state.resolve_package_selector",'
    '      "section_kind": "service_protocol_endpoint_binding",'
    '      "section_order": 109'
    "    },"
    "    {"
    '      "line_count": 39,'
    '      "rendered_text_digest": "sha256:254f5dea426de1fce5453087311d1274207127b362fa0d358113625d6a8af074",'
    ...
    "    {"
    '      "line_count": 6,'
    '      "rendered_text_digest": "sha256:aa0a2f6d5fe3fab29ffb80d9c9e8466f09e49ae100d5c1dfe0ba34b9a67f86f6",'
    '      "section_key": "api.service_protocol.capability_protocol:code.view_action",'
    '      "section_kind": "service_protocol_capability_protocol",'
    '      "section_order": 124'
    "    },"
    "    {"
    '      "line_count": 6,'
    '      "rendered_text_digest": "sha256:cd8cbfd10b7d43f11d1af42a77d869836fe50a75729aa3fadf3e48723bebd96a",'
    '      "section_key": "api.service_protocol.capability_protocol:code.view_state",'
    '      "section_kind": "service_protocol_capability_protocol",'
    '      "section_order": 125'
    "    },"
    "    {"
    '      "line_count": 17,'
    '      "rendered_text_digest": "sha256:5c4a9960742f402b6dcb40ae8cfafe790e540c5e2557c48d1a68d7c39983aa93",'
    ...
    "    {"
    '      "line_count": 139,'
    '      "rendered_text_digest": "sha256:b1fad3bc1e195f7d93ea415ca11de13b579f3f13113bbfc1c4250913bd6dce93",'
...
__all__ = [
    ...
    "CodeViewActionCapabilityServiceProtocol",
    "CodeViewStateCapabilityServiceProtocol",
    ...
    "CODE__VIEW_ACTION__SELECT_CODE_ENDPOINT_REF",
    "CODE__VIEW_ACTION__SELECT_CODE_PROTOCOL_BINDING",
    "invoke_code__view_action__select_code",
    "CODE__VIEW_ACTION__SELECT_SECTION_ENDPOINT_REF",
    "CODE__VIEW_ACTION__SELECT_SECTION_PROTOCOL_BINDING",
    "invoke_code__view_action__select_section",
    "CODE__VIEW_STATE__RESOLVE_EDITOR_ENDPOINT_REF",
    "CODE__VIEW_STATE__RESOLVE_EDITOR_PROTOCOL_BINDING",
    "invoke_code__view_state__resolve_editor",
    "CODE__VIEW_STATE__RESOLVE_PACKAGE_SELECTOR_ENDPOINT_REF",
    "CODE__VIEW_STATE__RESOLVE_PACKAGE_SELECTOR_PROTOCOL_BINDING",
    "invoke_code__view_state__resolve_package_selector",
]
