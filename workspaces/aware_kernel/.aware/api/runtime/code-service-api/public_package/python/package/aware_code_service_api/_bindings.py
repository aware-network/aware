        ...
        "apis": [
            {
                "capabilities": [
                    ...
                    },
                    {
                        "endpoints": [
                            {
                                "description": "Select one Code source in the package "
                                "selector and request downstream editor "
                                "focus.",
                                "discriminant": "code.view_action.select_code",
                                "name": "select_code",
                                "request": {
                                    "class_ref": "aware_code_service_dto.code.SelectCodeViewActionRequest",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "response": {
                                    "class_ref": "aware_code_service_dto.code.SelectCodeViewActionResponse",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "source_path": "bindings/code.apis.aware",
                            },
                            {
                                "description": "Select one Code section anchor in the " "editor view.",
                                "discriminant": "code.view_action.select_section",
                                "name": "select_section",
                                "request": {
                                    "class_ref": "aware_code_service_dto.code.SelectCodeSectionViewActionRequest",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "response": {
                                    "class_ref": "aware_code_service_dto.code.SelectCodeSectionViewActionResponse",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "source_path": "bindings/code.apis.aware",
                            },
                    ...
                    },
                    {
                        "endpoints": [
                            {
                                "description": "Resolve Code editor view data through " "the Code service read model.",
                                "discriminant": "code.view_state.resolve_editor",
                                "name": "resolve_editor",
                                "request": {
                                    "class_ref": "aware_code_service_dto.code.ResolveCodeEditorViewRequest",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "response": {
                                    "class_ref": "aware_code_service_dto.code.ResolveCodeEditorViewResponse",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "source_path": "bindings/code.apis.aware",
                            },
                            {
                                "description": "Resolve Code package selector view "
                                "data through the Code service read "
                                "model.",
                                "discriminant": "code.view_state.resolve_package_selector",
                                "name": "resolve_package_selector",
                                "request": {
                                    "class_ref": "aware_code_service_dto.code.ResolveCodePackageSelectorViewRequest",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "response": {
                                    "class_ref": "aware_code_service_dto.code.ResolveCodePackageSelectorViewResponse",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "source_path": "bindings/code.apis.aware",
                            },
                        ...
                        "endpoints": [
                            {
                                ...
                                "request": {
                                    "class_ref": "aware_code_service_dto.code.SelectCodeViewActionRequest",
                                    "python_model_ref": "aware_code_service_dto.code.features.view_state.SelectCodeViewActionRequest",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "response": {
                                    "class_ref": "aware_code_service_dto.code.SelectCodeViewActionResponse",
                                    "python_model_ref": "aware_code_service_dto.code.features.view_state.SelectCodeViewActionResponse",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "source_path": "bindings/code.apis.aware",
                            },
                            {
                                ...
                                "description": "Select one Code section anchor in the " "editor view.",
                                "discriminant": "code.view_action.select_section",
                                "endpoint_ref": "code.view_action.select_section",
                                "fulfillment_bindings": [],
                                "invocation_kind": "shared_client_endpoint",
                                "name": "select_section",
                                "request": {
                                    "class_ref": "aware_code_service_dto.code.SelectCodeSectionViewActionRequest",
                                    "python_model_ref": "aware_code_service_dto.code.features.view_state.SelectCodeSectionViewActionRequest",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "response": {
                                    "class_ref": "aware_code_service_dto.code.SelectCodeSectionViewActionResponse",
                                    "python_model_ref": "aware_code_service_dto.code.features.view_state.SelectCodeSectionViewActionResponse",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "source_path": "bindings/code.apis.aware",
                            },
                        ...
                        "endpoints": [
                            {
                                ...
                                "description": "Resolve Code editor view data through " "the Code service read model.",
                                "discriminant": "code.view_state.resolve_editor",
                                "endpoint_ref": "code.view_state.resolve_editor",
                                "fulfillment_bindings": [],
                                "invocation_kind": "shared_client_endpoint",
                                "name": "resolve_editor",
                                "request": {
                                    "class_ref": "aware_code_service_dto.code.ResolveCodeEditorViewRequest",
                                    "python_model_ref": "aware_code_service_dto.code.features.view_state.ResolveCodeEditorViewRequest",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "response": {
                                    "class_ref": "aware_code_service_dto.code.ResolveCodeEditorViewResponse",
                                    "python_model_ref": "aware_code_service_dto.code.features.view_state.ResolveCodeEditorViewResponse",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "source_path": "bindings/code.apis.aware",
                            },
                            {
                                ...
                                "model.",
                                "discriminant": "code.view_state.resolve_package_selector",
                                "endpoint_ref": "code.view_state.resolve_package_selector",
                                "fulfillment_bindings": [],
                                "invocation_kind": "shared_client_endpoint",
                                "name": "resolve_package_selector",
                                "request": {
                                    "class_ref": "aware_code_service_dto.code.ResolveCodePackageSelectorViewRequest",
                                    "python_model_ref": "aware_code_service_dto.code.features.view_state.ResolveCodePackageSelectorViewRequest",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "response": {
                                    "class_ref": "aware_code_service_dto.code.ResolveCodePackageSelectorViewResponse",
                                    "python_model_ref": "aware_code_service_dto.code.features.view_state.ResolveCodePackageSelectorViewResponse",
                                    "source_path": "bindings/code.apis.aware",
                                },
                                "source_path": "bindings/code.apis.aware",
                            },
...
ENDPOINT_REF_BY_NAME: Final[dict[str, str]] = {
    ...
    "code.view_action.select_code": CODE__VIEW_ACTION__SELECT_CODE_ENDPOINT_REF,
    "code.view_action.select_section": CODE__VIEW_ACTION__SELECT_SECTION_ENDPOINT_REF,
    "code.view_state.resolve_editor": CODE__VIEW_STATE__RESOLVE_EDITOR_ENDPOINT_REF,
    "code.view_state.resolve_package_selector": CODE__VIEW_STATE__RESOLVE_PACKAGE_SELECTOR_ENDPOINT_REF,
}
