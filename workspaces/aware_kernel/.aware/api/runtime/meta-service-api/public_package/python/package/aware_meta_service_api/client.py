...
class MetaViewActionCapabilityClient:
    def __init__(self, client: AwareApiEndpointInvoker) -> None:
        self._client = client
    ...
    async def select_identity(
        ...
        """Select one identity in the Meta graph canvas and request view-state refresh coordinates."""
        return cast(
            MetaGraphSelectIdentityViewActionResponse,
            await self._client.invoke_api_endpoint(
                manifest=API_INVOCATION_MANIFEST,
...
class MetaApiClient:
    def __init__(self, client: AwareApiEndpointInvoker) -> None:
        ...
        self.view_action = MetaViewActionCapabilityClient(client)
...
__all__ = [
    ...
    "MetaViewActionCapabilityClient",
