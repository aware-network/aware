...
from aware_meta_service_dto.graph.view.graph_view import (
    ...
    MetaGraphSelectIdentityViewActionRequest,
    MetaGraphSelectIdentityViewActionResponse,
)
...
async def invoke_meta__view_action__select_identity(
    handler: object, request: BaseModel, execution: ServiceProtocolExecution | None = None
) -> MetaGraphSelectIdentityViewActionResponse:
    typed_handler = cast(AwareMetaServiceProtocol, handler)
    typed_request = MetaGraphSelectIdentityViewActionRequest.model_validate(request)
    return await typed_handler.meta.view_action.select_identity(typed_request)


META__VIEW_ACTION__SELECT_IDENTITY_ENDPOINT_REF: Final[str] = "meta.view_action.select_identity"
META__VIEW_ACTION__SELECT_IDENTITY_PROTOCOL_BINDING: Final[ServiceProtocolEndpointBinding] = (
    ServiceProtocolEndpointBinding(
        endpoint_ref=META__VIEW_ACTION__SELECT_IDENTITY_ENDPOINT_REF,
        api_name="meta",
        capability_name="view_action",
        endpoint_name="select_identity",
        request_type_ref="aware_meta_service_dto.graph.view.MetaGraphSelectIdentityViewActionRequest",
        response_type_ref="aware_meta_service_dto.graph.view.MetaGraphSelectIdentityViewActionResponse",
        stream_event_type_refs=(),
        execution_protocol_ref=None,
        build_execution=None,
        stream_invoke=None,
        fulfillment_bindings=(),
        invoke=invoke_meta__view_action__select_identity,
    )
)
...
ENDPOINT_BINDINGS: Final[dict[str, ServiceProtocolEndpointBinding]] = {
    ...
    META__VIEW_ACTION__SELECT_IDENTITY_ENDPOINT_REF: META__VIEW_ACTION__SELECT_IDENTITY_PROTOCOL_BINDING,
}
...
class MetaViewActionCapabilityServiceProtocol(Protocol):

    async def select_identity(
        self, request: MetaGraphSelectIdentityViewActionRequest
    ) -> MetaGraphSelectIdentityViewActionResponse: ...
...
class MetaApiServiceProtocol(Protocol):
    ...
    view_action: MetaViewActionCapabilityServiceProtocol
...
SERVICE_PROTOCOL_RENDER_SECTION_MANIFEST_JSON: Final[str] = (
    ...
    '  "described_sections_text_digest": "sha256:f107674b9d1a4b8daa7f58dfed056897c3377ca632bc73331a0437f59eaca056",'
    ...
    "    {"
    '      "line_count": 22,'
    '      "rendered_text_digest": "sha256:e5b63b2cc00dcedae96418b0e85e18b36f06926b80a63ba4cfef25b9ff95b889",'
    ...
    '      "line_count": 0,'
    '      "rendered_text_digest": "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",'
    '      "section_key": "api.service_protocol.endpoint_execution:meta.view_action.select_identity",'
    '      "section_kind": "service_protocol_endpoint_execution",'
    '      "section_order": 13'
    "    },"
    "    {"
    ...
    "    {"
    '      "line_count": 5,'
    '      "rendered_text_digest": "sha256:a8edff369aca9cf2b1fcd9e36b8ec95639f72215bd9791a888d18b5b97e5ad62",'
    '      "section_key": "api.service_protocol.endpoint_invoker:meta.view_action.select_identity",'
    '      "section_kind": "service_protocol_endpoint_invoker",'
    '      "section_order": 36'
    "    },"
    "    {"
    '      "line_count": 18,'
    '      "rendered_text_digest": "sha256:d60abf4020073a070e61da8f5a9cf825050823620fa073466c83441afdfa6387",'
    '      "section_key": "api.service_protocol.endpoint_binding:meta.view_action.select_identity",'
    '      "section_kind": "service_protocol_endpoint_binding",'
    '      "section_order": 37'
    "    },"
    "    {"
    '      "line_count": 15,'
    '      "rendered_text_digest": "sha256:e93486a4e9a68c6f9f27f94485651951819ddcdf554129a27f25e97075a0a9d2",'
    ...
    "    {"
    '      "line_count": 4,'
    '      "rendered_text_digest": "sha256:01188a3f7659fba8c7669e977108db6bc508af1adb00ee8329bcddfcda58e221",'
    '      "section_key": "api.service_protocol.capability_protocol:meta.view_action",'
    '      "section_kind": "service_protocol_capability_protocol",'
    '      "section_order": 45'
    "    },"
    "    {"
    '      "line_count": 9,'
    '      "rendered_text_digest": "sha256:98c3f83c0ec9137e83bf71e1d464822c4d7dca8d2c70b545dbf340a0e5c1ddff",'
    ...
    "    {"
    '      "line_count": 61,'
    '      "rendered_text_digest": "sha256:7fd6442080aa151b0178bde5f69d6d5ffd4bf2195566997d4a6f2d9ea3e312f0",'
...
__all__ = [
    ...
    "MetaViewActionCapabilityServiceProtocol",
    ...
    "META__VIEW_ACTION__SELECT_IDENTITY_ENDPOINT_REF",
    "META__VIEW_ACTION__SELECT_IDENTITY_PROTOCOL_BINDING",
    "invoke_meta__view_action__select_identity",
]
