# aware_ontology_service_api

Generated API client package.

Public generated API client and service protocol boundary for Ontology-owned GraphOS operations over Meta commit authority.

## Install

```bash
pip install aware-ontology-service-api
```
...
api = AwareOntologyServiceApiClient(AwareApiEndpointInvoker(...))
```
